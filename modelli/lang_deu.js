DB_anatomia={
	"Osso_ILIACO": {
		...
		"Descrizione": "<p>Der Beckenknochen ist das Hüftbein und stellt zusammen mit dem Kreuzbein und dem Steißbein einen der Beckenknochen dar. Es handelt sich um ein paariges Element, das sich an den Seiten des oben genannten Kreuzbeins entwickelt.<br> Aus anatomischer Sicht, kann der Beckenknochen in drei Regionen unterteilt werden: eine obere Region, die als Ilium bezeichnet wird, eine untere hintere Region, die als Ischium bezeichnet wird, und eine untere vordere Region, die als Schambein bezeichnet wird.<br> Jeder Beckenknochen bildet drei Gelenke: das Iliosakralgelenk mit dem Kreuzbein, das Hüftgelenk mit dem Oberschenkelknochen und das Schambeinfugengelenk mit dem kontralateralen Beckenknochen.</p><p> <i>Lage:</i> zwischen den Kreuzbein und die unteren Gliedmassen (Oberschenkelknochen)<br><i>Wirkung:</i> Zusätzlich zu seinem Beitrag zu einem wichtigen Gelenk wie die Hüfte, dient der Beckenknochen als Ursprung und Ansatz für Muskeln in verschiedenen Bereichen, besonders Bauch, Rücken,Oberschenkel<br> <i>Klassifizierung:</i> flache Knochen.</p>"
	},
	"Osso_CRANIO": {
		"Titolo": "Schädel",
		"Descrizione": "<p>Der Schädel besteht aus 8 Knochen: dem Stirnbein, zwei Schläfenbeinen, zwei Scheitelbeinen, dem Keilbein, dem Siebbein und dem Hinterhauptbein.</p><p> <i>Lage:</i> Es ist ähnlich wie eine Schale und liegt oberhalb der Nasen- und Oberkieferknochen sowie vor den beiden Scheitelbeinen.<br><i>Wirkung:</i> Die Schädelknochen dienen in erster Linie dem Schutz verschiedener Gehirnstrukturen (Großhirn, Zwischenhirn, Kleinhirn und Hirnstamm) und der in der Schädeldecke befindlichen Sinnesorgane<br> <i>Klassifizierung:</i> flache Knochen, außer der Keil- und Siebbein Knochen, die als kurze Knochen gelten.</p>"
	},
	"Osso_MANDIBOLA": {
		"Titolo": "Unterkiefer",
		"Descrizione": "<p>Der Unterkiefer oder Unterkieferknochen ist der U-förmige Gesichtsknochen, der den unteren Zahnbogen beherbergt und zusammen mit dem Oberkieferknochen den Mund bildet. Unter den verschiedenen Gesichtsknochen ist er der größte, stärkste und der einzige, der die Möglichkeit hat, sich selbst zu bewegen.</p><p> <i>Lage:</i> Es befindet sich im unteren Teil des Schädels und bildet das Kiefergelenk, zusammen mit dem Oberkieferknochen bildet er den Mund<br><i>Wirkung:</i> Kauen und Sprachbewegungen<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_OMERO": {
		"Titolo": "Oberarmknochen",
		"Descrizione": "<p>Der Oberarmknochen ist der ausgleiche Knochen im menschlichen Körper, der das Skelett jedes Arms bildet.</p><p> <i>Lage:</i> liegt zwischen dem Schulterblatt (dem Hauptknochen der Schulter) und den Knochen des Unterarms (Speiche und Elle)<br> <i>Wirkung:</i> Es ist wichtig für die Bildung von zwei wichtigen Gelenken der oberen Gliedmaße: dem Schultergelenk und dem Ellenbogengelenk<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	...
	"Osso_CARPO": {
		"Titolo": "Handwurzel",
		"Descrizione": "<p>Die Knochen, aus denen die Handwurzel der menschlichen Hand besteht und auch Handwurzelknochen genannt wird, sind: Kahnbein, Mondbein, Triquetrum, pisiforme, Trapezium, Trapezoid, Kopfbein und Hamatum.</p><p> <i>Lage:</i> Die Handwurzel ist der Teil des Skeletts der oberen Extremität, der den Radius mit dem Mittelhandknochen verbindet. Es befindet sich im Bereich des Handgelenks<br> <i>Wirkung:</i> Sie sind nicht besonders beweglich, aber wichtig für die Stabilität des Handgelenks<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_METACARPO": {
		"Titolo": "Mittelhand",
		"Descrizione": "<p>Der Mittelhandknochen besteht aus fünf Knochen, die den zentralen Teil der Hand bilden.</p><p> <i>Lage:</i> In jeder Hand befinden sie sich zwischen den Handwurzelknochen und den proximalen Glied jedes Fingers<br> <i>Wirkung:</i> Die Handknochen erlauben die Fähigkeit des Griff der Hand, geben dem Kind eine Stabilität während der Gang auf allen vieren, bilden sehr wichtige Gelenke (z. B. das Handgelenk) und bieten Ansatzpunkte für die Sehnen der Handmuskeln<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_ASTRAGALO": {
		"Titolo": "Astragalus (oder Talus)",
		"Descrizione": "<p>Der Astragalus ist der zweite größte Knochen des Fußes und besteht anatomisch aus drei Teilen: dem Körper, dem Hals und dem Kopf.</p><p> <i>Lage:</i> Der Körper des Astragalus gliedert sich nach oben mit dem Schien- und Wadenbein, um das Sprunggelenk zu bilden, und nach unten mit dem Fersenbein, um das Subtastragalusgelenk zu bilden<br> <i>Wirkung:</i> Die grundlegende Aufgabe des Astragalus besteht darin, die Kraft vom gesamten Körper durch das Knöchel auf den Fuß zu übertragen<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_CALCAGNO": {
		"Titolo": "Calcaneus",
		"Descrizione": "<p>Der Calcaneus ist der größte Knochen, dass aus dem Fuß (Fußwurzel) besteht.</p><p> <i>Lage:</i> Es befindet sich im hinteren Bereich (die Ferse) und gliedert sich mit zwei Knochen: dem Astragalus, der das Subastragalusgelenk bildet, und dem Quader, der das Quadrichecalcaneusgelenk bildet<br> <i>Wirkung:</i> Der Calcaneus dient als Ansatzpunkt für drei Muskeln: die beiden Komponenten des Trizeps des surae, das heißt Gastrocnemius und Soleus, und den Plantar-Muskel. Diese Muskeln, auch mit einer schwachen Wirkung auf das Kniegelenk, wirken aber vor allem auf das Sprunggelenk, als den Beuger (Plantar) des Fußes<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_CARTILAGINI_STERNOCOSTALI": {
		"Titolo": "Sternokostalknorpel",
		"Descrizione": "<p>Die Gelenkfläche des Brustbeinknorpels besteht aus zwei konvergierenden keilförmigen Facetten, die durch einen vorder-posterioren Kamm getrennt sind. Am seitlichen Rand des Brustbeins befinden sich zwei flache Facetten, die so geneigt sind, eine Rippeneinschnitt zu bilden, in der sich der Knorpelkeil befindet.</p><p> <i>Lage:</i> zwischen den vorderen Enden der ersten sieben Rippen und den seitlichen Einschnitten an den Rändern des Brustbeins<br> <i>Wirkung:</i> Die Sternokostal-, Interchondral- und Brustbeinegelenke erlauben die nötige Beweglichkeit des Brustkorbs für Atembewegungen<br> <i>Klassifizierung:</i> Knorpel</p>"
	},
	"Osso_CLAVICOLA": {
		"Titolo": "Schlüsselbein",
		"Descrizione": "<p>Das Schlüsselbein ist ein paariger mit S-Form, medial konvex und lateral konkav Beinelement</p><p> <i>Lage:</i> Es befindet sich im anteroposterioren Teil der Brust und verbindet das Manubrium des Brustbeins mit dem Schulterdach des Schulterblatts. Man kann in drei Hauptregionen unterteilt werden: den Körper, das Brustbeinende und das Akromieende<br> <i>Funktion:</i> Das Schlüsselbein erfüllt drei gleiche wichtige Funktionen: Es stützt den Arm und das Schulterblatt und ermöglicht deren Verbindung mit dem Rumpf. Aufgrund der Bänder, an denen es befestigt ist, und seiner besonderen Anatomie, ermöglicht es ein breites Spektrum an Armbewegungen<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_COSTE": {
		"Titolo": "Rippen",
		"Descrizione": "<p>Die Rippen sind die 24 spitz zulaufenden und gebogenen (oder bogenförmigen) Knochen, die zusammen mit der Brustwirbelsäule den Brustkorb bilden.</p><p> <i>Lage:</i> Sie entspringen an den Seiten der 12 Brustwirbeln und reichen fast bis in den vorderen Bereich der Brust<br> <i>Wirkung:</i> Die Hauptfunktion der Rippen besteht darin, die lebenswichtigen Organe (wie Herz und Lunge) und die großen Blutgefäße (wie die Aorta und die Hohlvene) in der Brusthöhle zu schützen<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FEMORE": {
		"Titolo": "Oberschenkelknochen",
		"Descrizione": "<p>Der Oberschenkelknochen stellt den Oberschenkelskelett dar, und besteht aus zwei Enden, den sogenannten Epiphysen, und einem Körper, der Diaphyse genannt wird. Die Diaphyse hat eine prismatische Form mit drei Flächen und drei Kanten.</p><p> <i>Lokalisierung:</i> Sie befindet sich im Oberschenkel zwischen Becken und den Knie<br><i>Wirkung:</i> Der Oberschenkelknochen ist ein wichtiges Knochen für die gleichmäßige Verteilung der Kräfte und des Körpergewichts auf die untere Extremität und für die Fortbewegung (die Muskeln, mit denen er verbunden ist, sind für das Gehen, Laufen und Springen unerlässlich).<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_IOIDE": {
		"Titolo": "Zungenbein",
	...
	"Osso_ATLANTE": {
		"Titolo": "Atlas",
		"Descrizione": "<p>In der Anatomie ist der Atlas (C1) der erste Halswirbel der Wirbelsäule. Sein Name leitet sich vom mythologischen Atlas ab, da er den Kopf wie eine Weltkugel trägt.</p><p> <i>Lage:</i> Es artikuliert mit dem Hinterhauptbein und hat seine eigenen Eigenschaften. Ihm fehlt ein Wirbelkörper, der mit dem des zweiten Wirbels zum Processus odontoideus verschmolzen ist<br> <i>Wirkung:</i> Der Atlas bildet zusammen mit dem Epistropheus das Gelenk, das den Schädel mit der Wirbelsäule verbindet. Atlas und Epistropheus sind so angepasst, um im Vergleich zu anderen Wirbeln ein höheres Maß an Beweglichkeit zu ermöglichen<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_EPISTROFEO": {
		"Titolo": "Epistropheus (oder Axis)",
		"Descrizione": "<p>Der Dornfortsatz des Epistropheus hat seinen Ursprung auf der Außenseite des Wirbelbogens, auf halbem Weg zwischen den beiden Stielen. Er ist ein großer knöcherner Vorsprung, der sich an einer bestimmten Stelle in seinem unteren Teil gabelt und eine Rinne bildet.</p><p> <i>Lage:</i> Der Epistropheus befindet sich zwischen dem Atlas (erster Halswirbel) nach oben und dem dritten Halswirbel nach unten<br> <i>Wirkung:</i> Dank des Zinnes, fungiert der Epistropheus als Drehpunkt für den Atlas und ermöglicht so eine größere Flexibilität bei der Drehung von Hals und Kopf<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_FALANGETTE_MANO": {
		"Titolo": "Distale Phalangen der Hand",
		"Descrizione": "<p>Knochen, die einen Teil des Skeletts der Finger der Hand bilden.</p><p> <i>Lage:</i> zwischen den mittleren Fingergliedern der Hand und den Fingernägeln<br><i>Wirkung:</i> Sie ermöglichen die Bewegung der Finger der Hand<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FALANGI_MANO": {
		"Titolo": "Proximale Fingerglieder der Hand",
		"Descrizione": "<p>Knochen, die einen Teil des Skeletts der Finger der Hand bilden.</p><p> <i>Lage:</i> zwischen den Mittelhandknochen und den mittleren Fingerglieder der Finger der Hand<br><i>Wirkung:</i> Sie ermöglichen die Bewegung der Finger der Hand<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FALANGINE_MANO": {
		"Titolo": "Mittlere Fingerglieder der Hand",
		"Descrizione": "<p>Knochen, die einen Teil des Handskeletts bilden.</p><p> <i>Lage:</i> zwischen den proximalen Fingerglieder und den distalen Fingerglieder der Hand<br><i>Wirkung:</i> Sie ermöglichen die Bewegung der Finger der Hand<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FALANGETTE_PIEDE": {
		"Titolo": "Distale Fingerglieder des Fußes",
		"Descrizione": "<p>Knochen, die einen Teil des Skeletts der Zehen des Fußes bilden.</p><p> <i>Lage:</i> zwischen den mittlere Fingerglieder des Fußes und den Zehennägeln<br> <i>Wirkung:</i> Sie ermöglichen die Bewegung der Fußzehen und tragen beim Gehen das gesamte Körpergewicht<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FALANGI_PIEDE": {
		"Titolo": "Proximale Fingerglieder des Fußes",
		"Descrizione": "<p>Knochen, die einen Teil des Skeletts der Zehen des Fußes bilden.</p><p> <i>Lage:</i> zwischen den Mittelfußknochen und den Mittlere Fingerglieder des Fußes<br> <i>Wirkung:</i> Sie ermöglichen die Bewegung der Fußzehen und tragen beim Gehen das gesamte Körpergewicht<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_FALANGINE_PIEDE": {
		"Titolo": "Mittlere Fingerglieder des Fußes",
		"Descrizione": "<p>Knochen, die einen Teil des Skeletts der Zehen des Fußes bilden.</p><p> <i>Lage:</i> zwischen den proximalen Fingerglieder und den distalen Fingerglieder des Fußes<br> <i>Wirkung:</i> Sie ermöglichen die Bewegung der Fußzehen und tragen beim Gehen das gesamte Körpergewicht<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_PERONE": {
		"Titolo": "Wadenbein",
		"Descrizione": "<p>Das Wadenbein, oder Wadenbein, ist ein Knochen der unteren Gliedmaßen. Es ist lang und schlank, etwa 4-5 mal dünner als das Schienbein und vervollständigt zusammen mit ihm das Skelett des Beines.</p><p> <i>Lage:</i> Es bildet mit dem Schienbein das Skelett des Beines. Es befindet sich zwischen Kniegelenk und Knöchel<br> <i>Wirkung:</i> Es formt das Kniegelenk (durch den Kontakt mit dem Oberschenkelknochen) und den Knöchel (durch Kontakt mit dem Astragal)<br> <i>Klassifizierung:</i> Röhrenknochen.</p>"
	},
	"Osso_RADIO": {
		"Titolo": "Radius",
	...
	"Osso_SACRO": {
		...
		"Descrizione": "<p>Das Kreuzbein ist ein ungleicher, asymmetrischer und dreieckiger Knochen.</p><p> <i>Lage:</i> Es befindet sich im unteren Teil der Wirbelsäule, genau zwischen der Lendengegend und dem Steißbein. Tatsächlich stellt das Kreuzbein den hinteren und zentralen Teil des Beckens dar<br><i>Wirkung:</i> Es ermöglicht dem Menschen, das Hüftgelenk nach außen zu drehen, abzuduzieren, zu strecken und zu stabilisieren<br> <i>Klassifizierung:</i> flacher Knochen.</p>"
	},
	"Osso_COCCIGE": {
		"Titolo": "Steißbein",
		"Descrizione": "<p>Das Steißbein ist die unregelmäßige Knochenstruktur, die im Allgemeinen aus 4 Wirbeln besteht und das letzte Segment der Wirbelsäule mit dreieckiger Form bildet.</p><p> <i>Lage:</i> Unterhalb des Kreuzbeins gelegen, ist das Steißbein der Überrest des Schwanzes, der bei unseren Vorfahren in sehr fernen Zeiten vorhanden war.<br><i>Wirkung:</i> Es schützt den Endteil des Knochenmarks, trägt das Körpergewicht in sitzender Lage und dient als Befestigungspunkt für Muskeln (zum Beispiel ein großes Gesäßmuskel und Hebe des Anus), Bänder und Sehnen<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_SCAPOLE": {
	...
	"Osso_TARSO": {
		"Titolo": "Fußwurzel",
		"Descrizione": "<p>Es gibt sieben Fußwurzelknochen: Astragal, Fersenbein, Quader, Strahlbein sowie das erste, zweite und dritte Keilbein. Der Fußwurzel hat eine konkave, nach unten gerichtete, gewölbte Form.</p><p> <i>Lage:</i> Die Fußwurzelknochen befinden sich im Fuß zwischen dem Knöchel und den Mittelfußknochen<br><i>Wirkung:</i> Sie ermöglichen die Dorsalbeuge, die Plantarbeuge, die Eversion und Inversion des Fußes<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	"Osso_TIBIA": {
		"Titolo": "Schienbein",
	...
	"Osso_VERTEBRE_CERVICALI": {
		"Titolo": "Halswirbel",
		"Descrizione": "<p>Die Halswirbel sind 7 (von C1 bis C.7). Die Halswirbelsäule ist der beweglichste und in mancher Hinsicht den empfindlichste Teil der Wirbelsäule.</p><p> <i>Lage:</i> Sie artikulieren nach oben mit den Knochen an der Schädelbasis und nach unten mit den Rückenwirbeln<br><i>Wirkung:</i> Neben der Unterstützung, Stabilisierung und Beweglichkeit des Schädels schützen sie auch die durch ihn verlaufenden Strukturen wie das Rückenmark, die Nervenwurzeln und die Wirbelarterie<br> <i>Klassifizierung:</i> kurze Knochen.</p>"
	},
	...
	"Muscolo_MASSETERE": {
		...
		"Descrizione": "<i>Herkunft:</i> Jochbein<br> <i>Ansatz:</i> Unterkieferknochen<br><i>Wirkung:</i> Vorstehen und Anheben des Unterkiefers<br> <i>Innervation:</i> Trigeminusnerv<br> <i>Vaskularisation:</i> Gesichtsarterie",
		"baseImg": true
	},
	"Muscolo_TEMPORALE": {
	...
	"Muscolo_SPLENIO_DELLA_TESTA": {
		"Titolo": "Milz-Kopfmuskel",
		"Descrizione": "<i>Herkunft:</i> Dornfortsätze der Wirbel C7 bis T4 und unterer Teil des nackene Bandes<br> <i>Ansatz:</i> Warzenfortsatz des Schläfenbeins, laterale obere nackene Linie<br><i>Wirkung (doppelseitig):</i> Streckung der Kopf und Hals<br><i>Wirkung (einseitig):</i> Seitliche Neigung und Drehung des Halses<br> <i>Innervation:</i> Untere mittlere Halsnerven, hintere Äste<br> <i>Vaskularisation:</i> tiefe Halsarterie",
		"baseImg": true
	},
	...
	"Muscolo_TRAPEZIO": {
		"Titolo": "Trapezmuskel",
		"Descrizione": "<i>Herkunft:</i> obere Nackenlinie, Hinterhauptbein, Nackenband, Dornfortsätze und supraspinale Bänder von C7 bis T12<br> <i>Ansatz:</i> Hinterer Rand des Schlüsselbeins, Akromion, Wirbelsäule des Schulterblatts<br><i>Wirkung:</i> Anhebung des Schulterblatts, Adduktion des Schulterblatts, Senkung des Schulterblatts gegen Widerstand, Rotation des Schulterblatts<br> <i>Innervation:</i> akzessorischer Nerv<br> <i>Vaskularisation:</i> oberflächliche Halsarterie",
		"baseImg": true
	},
	...
	"Muscolo_DENTATO_ANTERIORE": {
		"Titolo": "Vorderer Zähnmuskel",
		"Descrizione": "<i>Herkunft:</i> 1. bis 9. Rippe<br> <i>Ansatz:</i> Schulterblatt, medialer Rand und unterer Winkel<br><i>Wirkung:</i> Rotation des Schulterblatts mit Abduktion und Beugung des Arms, Protraktion des Schulterblatts<br> <i>Innervation:</i> langer Brustnerv (C5-C7)<br> <i>Vaskularisation:</i> laterale Brustarterie",
		"baseImg": true
	},
	"Muscolo_PETTORALE": {
	...
	"Muscolo_ADDUTTORE_ALLUCE": {
		"Titolo": "Adduktormuskel des Großes Zehe",
		"Descrizione": "<i>Herkunft (Querkopf):</i> Mittelfußgliedgelenke der 3. bis 5. Zehe<br><i>Herkunft (Schrägkopf):</i> Mittelfußknochen der 2. bis 4. Zehe und lange Wadenbein, Sehnenscheide<br> <i>Ansatz:</i> Grundglied der 1. Zehe, Seitenfläche<br> <i>Aktion:</i> Adduktion der 1. Zehe<br> <i>Innervation:</i> lateraler Plantarnerv S2-S3<br> <i>Vaskularisation:</i> mediale und laterale Plantararterie, plantare Mittelfußarterie und plantar arterieller Bogen",
		"baseImg": true
	},
	...
	"Muscolo_TIROIDEO": {
		...
		"Descrizione": "<p><i>Herkunft:</i> stammt aus dem Brustbein und dem Schilddrüsenknorpel<br> <i>Insertion:</i> Einsätze am Zungenbein<br> <i>Wirkung:</i> Seine Wirkung besteht darin, das Zungenbein zu senken und den Kehlkopf anzuheben<br> <i>Innervation:</i> innerviert durch den zervikale Plexus und den ipoglossus Nerv<br> <i>Vaskularisation:</i> versorgt durch die Schilddrüsenarterie (Äste der äußeren Halsschlagader) und die Schilddrüsenvenen</p>"
	},
	...
	"Muscolo_DEPRESSORE_ANGOLO_BOCCA": {
		...
		"Descrizione": "<p><i>Ursprung:</i> stammt aus dem unteren Teil der Außenseite des Unterkieferkörpers; dann erstreckt er sich nach oben und medial, um mit dem Orbicolar des mauts zu verschmelzen.<br> <i>Einsetzen:</i> Wird in die Haut der Oberlippe eingeführt.<br> <i>Wirkungsweise:</i> Dient zum Niederdrücken der Unterlippe und der Labiale Reim.<br> <i>Innervation:</i> innerviert durch den Gesichtsnerv.<br> <i>Vaskularisation:</i> versorgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_DEPRESSORE_LABBRO": {
		"Titolo": "Unterlippensenkmuskel",
		"Descrizione": "<p><i>Ursprung:</i> stammt aus dem unteren Teil der Außenseite des Unterkieferkörpers; dann erstreckt er sich nach oben und medial, bis mit dem orbicularis Muskel des Mauts zu verschmelzen.<br><i>Ansatz:</i> führt seine Fasern in die Haut der Oberlippe ein.<br> <i>Wirkung:</i> Dient zum Niederdrücken und Umstülpen der Unterlippe.<br> <i>Innervation:</i> Innervation durch den mundliche Zweig des Gesichtsnervs.<br> <i>Vaskularisation:</i> versorgt durch die Gesichtsarterie.</p>"
	},
	...
	"Muscolo_NASALE": {
		"Titolo": "Nasenmuskel",
		"Descrizione": "<p><i>Ursprung:</i> Sein transversaler Teil stammt aus der seitlichen Nasenwand, die sich vom lateralen Teil der Nase bis zum unteren Teil der Nasengrube erstreckt, während sein Flügelteil aus vom Oberkiefer, medial zum transversalen Teil, stammt.<br> <i>Ansatz:</i> Der Querteil wird an der Sehnenhaut befestigt, die sich über den Nasenrücken und auf Niveau des Deckes erstreckt, während der Flügelteil am Flügelknorpel des Nasenskeletts befestigt wird.<br> <i>Wirkung:</i> Beim Zusammenziehen drückt es die Seitenwand der Nase zusammen und verengt so das Nasenloch und das Vestibulum.<br> <i>Innervation:</i> Innervation durch den Mundast des Gesichtsnervs.<br> <i>Vaskularisation:</i> versorgt durch die Gesichtsarterie.</p>"
	},
	...
	"Muscolo_PROCERO": {
		...
		"Descrizione": "<p><i>Ursprung:</i> Es stammt aus den Stirnbein.<br><i>Ansatz:</i> Die Einführung erfolgt im oberen Teil der Nase.<br><i>Wirkung:</i> Es handelt sich um einen Gesichtsmuskel (es verändert die Gesichtsausdruck), der den weichen Teil der Nase mobilisiert, und bei Kontraktion Falten in der Nähe der Nasenwurzel verursacht. Es ist an dem typischen Gesichtsausdruck des Faltens der Augenbrauen beim Nachdenken beteiligt.<br> <i>Innervation:</i> Die Innervation erfolgt durch den siebten Hirnnerv.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_CORRUGATORE": {
		"Titolo": "Runzelnmuskel",
		"Descrizione": "<p><i>Herkunft:</i> Entsteht aus den medialen Ende des Augenbrauenbogens. Seine Fasern verlaufen oberhalb und seitlich zwischen dem Augenlid und dem orbitalen Teil des Auges<br><i>Ansatz:</i> Die Einführung erfolgt im tiefen Teil der Haut, oberhalb der Mitte des Augenhöhlenbogens.<br><i>Wirkung:</i> Es dient dazu, die Stirn zu runzeln.<br> <i>Innervation:</i> Die Innervation erfolgt durch den bukkalen Ast des Gesichtsnervs.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_BUCCINATORE": {
		"Titolo": "Buccinator-Muskel",
		"Descrizione": "<p><i>Herkunft:</i> Es entsteht aus der pterygomandibularis Raphe und den umgebenden knöchernen Strukturen.<br> <i>Ansatz:</i> Ansatz am Orbicolarmuskel des Mundes, am Lippenwinkel.<br><i>Wirkung:</i> Es dient dazu, die Wangen zu glätten und den Lippenwinkel seitlich zurückzuziehen.<br> <i>Innervation:</i> Die Innervation erfolgt durch den Mundast des Gesichtsnervs.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_ZIGOMATICO": {
		"Titolo": "Jochbeinmuskel",
		"Descrizione": "<p><i>Herkunft:</i> Es ist in drei Teile unterteilt: Jochbein, Infraorbital und Winkel. Der Muskel entsteht aus der Backenfläche des Jochbeins.<br> <i>Ansatz:</i> Ansatz an der zeitliche Band. Der hinteruntere Spanne oder Jochbeinrand ist dünn, glatt und gerade.<br><i>Wirkung:</i> Es ist ein Kau- und Ausdrucksmuskel.<br> <i>Innervation:</i> Die Innervation erfolgt durch die Jochbein- und Wangenäste des Gesichtsnervs.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_ELEVATORE_DEL_LABBRO": {
		"Titolo": "Hebenmuskel des Oberlippe",
		"Descrizione": "<p><i>Herkunft und Ansatz:</i> Es besteht aus drei Teilen: dem Jochbein, dem Infraorbital und dem Winkel. Der Jochbeinteil entspringt an der Seitenfläche des Jochbeins und setzt an der Haut der Oberlippe oberhalb der Fuge an. Der infraorbitale Teil entspringt am Infraorbitalrand und setzt an der Haut der Oberlippe an der medialen Seite des Endes des Jochbeinteils an. Der eckige Teil entspringt dem Frontalfortsatz des Oberkiefers und des Nasenbeins und setzt sich in die Haut des Nasenflügels und der Oberlippe ein.<br><i>Wirkung:</i> Durch Kontraktion des Elevators des Oberlippenmuskels werden die Oberlippe und der Nasenflügel angehoben.<br> <i>Innervation:</i> Die Innervation erfolgt durch den bukkalen Ast des Gesichtsnervs.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	"Muscolo_RISORIO": {
		"Titolo": "Risorius-Muskel",
		"Descrizione": "<p><i>Herkunft:</i> Sie entspringt der Parotisfaszie und erstreckt sich nach vorne bis zum Mundwinkel.<br> <i>Einführung:</i> Es dringt tief in die Haut ein.<br><i>Wirkung:</i> Es zieht den Mundwinkel zurück und spielt eine Rolle beim Lächeln und Lachen.<br> <i>Innervation:</i> Die Innervation erfolgt durch den Gesichtsnerv.<br> <i>Vaskularisierung:</i> Die Versorgung erfolgt durch die Gesichtsarterie.</p>"
	},
	...
	"Muscolo_ANCONEO": {
		...
		"Descrizione": "<p><i>Herkunft:</i> Es entsteht an der hinteren Oberfläche des epikondylus Oberschenkelknochen<br><i>Ansatz:</i> Die Einführung erfolgt im proximalen Viertel der dorsalen Oberfläche der Ellbogen<br> <i>Wirkungsweise:</i> Der brachiale trizeps Muskel arbeitet mit dem Muskel bei der Unterarmstreckung zusammen, führt außerdem den Ellbogen ab und stabilisiert sie<br> <i>Innervation:</i> Die Innervation erfolgt durch den radiale Nerv (C7, C8)<br> <i>Vaskularisation:</i> Die Versorgung erfolgt sowohl durch den mittleren Seitenast der tiefer brachiale Arterie als auch durch die wiederkehrend interbein Arterie</p>"
	},
	...
	"Muscolo_ABDUTTORE_LUNGO_POLLICE": {
		...
		"Descrizione": "<p><i>Herkunft:</i> Es entsteht an der dorsalen Oberfläche der Ellbogen, distal zum Kamm des Rückenmuskel, an der Interbeinmembran und der dorsalen Oberfläche des Radius<br><i>Ansatz:</i> Der Ansatz erfolgt durch Kreuzen der Insertionssehne durch das erste Kompartiment des Rückverbindung sowie an der Basis des ersten Mittelhandknochens<br> <i>Wirkung:</i> Es ist verantwortlich für die Abduktion des Daumens und unterstützt außerdem die Abduktion und Palmarflexion der Hand<br> <i>Innervation:</i> Die Innervation erfolgt durch den tiefen Ast des radiales Nerv (C7-C8).<br> <i>Vaskularisation:</i> versorgt durch die hintere Interbeinarterie</p>"
	},
	...
	"Muscolo_PALMARE_BREVE": {
		...
		"Descrizione": "<p><i>Herkunft:</i> Entsteht am medialen Rand der Mundsehnenhaut<br> <i>Ansatz:</i> Es wird am medialen Rand der ipotenar Ballen in der Derma eingeführt<br> <i>Wirkung:</i> Faltenbildung auf der Haut, die den ipotenar Ballen bedeckt<br> <i>Innervation:</i> Die Innervation erfolgt durch den ellbogisch Nerv (C8, T1)<br> <i>Vaskularisation:</i> versorgt durch die Ellearterie</p>"
	},
	"Muscolo_FLESSORE_MIGNOLO_MANO": {
		"Titolo": "Beuge Muskel des kleinen Fingers",
	...
	"Muscolo_FLESSORE_MIGNOLO_PIEDE": {
		"Titolo": "Beugmuskel des kleines Zehes",
		"Descrizione": "<p><i>Herkunft:</i> Entsteht an der Basis des fünften Mittelfußknochens<br> <i>Ansatz:</i> Der Ansatz erfolgt an der Basis der Grundglied der fünften Zehe<br><i>Wirkung:</i> Die Wirkung besteht darin, die fünfte Zehe des Fußes zu beugen und zu bewegen<br> <i>Innervation:</i> innerviert durch den seitliche plantar Nerv<br> <i>Vaskularisation:</i> Mittelfußarterie V.</p>"
	},
	...
	"Organo_MAMMELLE": {
		"Titolo": "Brüste",
		"Descrizione": "<p><i>Lage:</i> Sie befinden sich an der vorderen Brustwand im Brustbereich. Die Brüste sind ein paariges Organ, das aus zwei symmetrischen und hervorstehenden Strukturen besteht.<br> Die Brüste bestehen aus Drüsengewebe, einer Reihe von Milchgängen, Fettgewebe und anderen Stützgeweben<br> <i>Funktion:</i> Die Hauptfunktion jeder Brust hängt mit der Stillzeit zusammen. Aus einer physiologische Sicht, sind Brüste Nebendrüsen des weiblichen Fortpflanzungssystems.</p>"
	},
	"Organo_INTESTINO_TENUE": {
		"Titolo": "Dünndarm",
		"Descrizione": "<p><i>Lage:</i> Es befindet sich in der Bauchhöhle. Der Dünndarm beginnt an der Pylorusklappe, die ihn vom Magen trennt, und endet an der Ileozökalklappe<br> <i>Funktion:</i> Im Dünndarm findet man die Verdauung der Nahrung statt und ein erheblicher Teil der gewonnenen Nährstoffe wird absorbiert.</p>"
	},
	"Organo_DUODENO": {
		"Titolo": "Zwölffingerdarm",
		"Descrizione": "<p><i>Lage:</i> Er befindet sich zwischen Magen und Dünndarm und kann als erster Teil des Dünndarms betrachtet werden<br> <i>Funktion:</i> Der Zwölffingerdarm spielt eine entscheidende Rolle bei der ordnungsgemäßen Verdauung von Nahrungsmitteln. Beim Eintritt in den Zwölffingerdarm wird der Bolus, genannt Speisebrei, Enzymen ausgesetzt, die von zwei wichtigen Organen produziert werden: der Pankreas (Bauchspeicheln) und der Leber (Galle).</p>"
	},
	"Organo_TIMO": {
		"Titolo": "Thymusdrüse",
	...
	"Organo_APPENDICE": {
		"Titolo": "Anhang",
		"Descrizione": "<p><i>Lage:</i> Ursprünglich als Wurmfortsatz oder Blinddarm bekannt, wird er heute allgemein als Blinddarm bezeichnet. Es handelt sich um eine röhrenförmige anatomische Struktur, die Teil des Dickdarms ist. Es gehört zum proximalen Segment, das als Blinddarm bezeichnet wird<br> <i>Funktion:</i> Derzeit scheint es keine spezifische Funktion in unserem Körper zu haben. Es ist möglich, ohne diese zu leben.</p>"
	},
	"Organo_COLON_ASCENDENTE": {
		"Titolo": "Aufsteigender Kolon",
		"Descrizione": "<p><i>Lage:</i> Es befindet sich in der Bauchhöhle. Der aufsteigende Dickdarm, der etwa eineinhalb Meter lang ist, beginnt an der Ileozökalklappe und endet am Rektum und Analkanal<br> <i>Funktion:</i> Im aufsteigenden Dickdarm wird der Verdauungsprozess durch die Aufnahme von Wasser und Mineralien abgeschlossen. Dieses Segment sondert auch eine schleimige und glitschig Substanz in das Lumen ab, die schmiert es und den Stuhlgang erleichtert.</p>"
	},
	"Organo_COLON_TRASVERSO": {
		"Titolo": "Querkolon",
		"Descrizione": "<p><i>Lage:</i> Es befindet sich in der Bauchhöhle. Das etwa anderthalb Meter lang erstreckt es sich von der Ileozökalklappe bis zum Rektum und Analkanal<br> <i>Funktion:</i> Im Querkolon wird der Verdauungsprozess durch die Aufnahme von Wasser und Mineralien abgeschlossen. Dieses Segment sondert auch eine schleimige und glitschige Substanz in das Lumen ab, die es schmiert und den Stuhlgang erleichtert.</p>"
	},
	"Organo_COLON_DISCENDENTE": {
		"Titolo": "Absteigender Kolon",
	...
	"Organo_RETTO": {
		"Titolo": "Rektum",
		"Descrizione": "<p><i>Lage:</i> Das Rektum beginnt im Becken- oder absteigenderkolon auf Höhe des dritten Kreuzbeinwirbels und endet am Anus. Es ist in einen Beckenabschnitt, in dem sich die Rektalampulle befindet, und einen Analabschnitt unterteilt<br> <i>Funktion:</i> Das Rektum dient der Speicherung von Stuhl vor der Ausscheidung.</p>"
	},
	"Organo_ANO": {
		"Titolo": "Anus",
		"Descrizione": "<p><i>Lage:</i> Der Anus befindet sich in einer anatomischen Lage, die als hinteres Perineum bekannt ist, direkt vor dem Steißbein, am Grund der Furche zwischen den Gesäßbacken<br> <i>Funktion:</i> Der Anus ist die Öffnung, durch die der Stuhlgang beim Darmentleerung ausgeschieden wird. Der unwillkürliche Muskelteil ist wichtig, aber nicht grundlegend für die Mäßigkeit des Stuhles (fekälmäßigkeit). Der willkürliche Muskelteil ist eine Fortsetzung des Beugmuskel des Anus und für die Stuhlmäßigkeit unerlässlich.</p>"
	},
	"Organo_STOMACO": {
		"Titolo": "Magen",
		"Descrizione": "<p><i>Lage:</i> Der Magen liegt zwischen der Speiseröhre und dem Zwölffingerdarm in der Brusthöhle<br> <i>Funktion:</i> Der Magen erfüllt zahlreiche wichtige Funktionen. Es dient als Reservoir für den Bolus, der aus der Speiseröhre kommt. Es speichert den Bolus, bis er vollständig vom Magensaft angegriffen wird. Der Magen sondert Magensaft ab, eine glitschige Flüssigkeit, die von den Magendrüsen entlang der Wand des Fundus und des Körpers produziert wird. Durch die Wirkung von Salzsäure und Pepsin ist es an der Verdauung von Proteinen beteiligt.</p>"
	},
	"Organo_MILZA": {
		"Titolo": "Milz",
	...
	"Organo_UTERO": {
		"Titolo": "Gebärmutter",
		"Descrizione": "<p><i>Lage:</i> Die Gebärmutter entspringt an der Öffnung der Salpinx und mündet in die darunter liegende Vaginalhöhle<br> <i>Funktion:</i> Die Gebärmutter ist das Organ, das dafür verantwortlich ist, die befruchtete Eizelle aufzunehmen, ihre Entwicklung zu unterstützen und den Fötus auszustoßen, wenn die Schwangerschaft zu Ende geht. Die Gebärmutter unterliegt in den verschiedenen Phasen der sexuellen Entwicklung einer Frau (Präpubertät, Pubertät, Geschlechtsreife, Wechseljahre), während der Schwangerschaft und während des gesamten Menstruationszyklus.</p>"
	},
	"Organo_TUBE": {
		"Titolo": "Eileiter",
		"Descrizione": "<p><i>Lage:</i> Die Eileiter, auch Salpinx genannt, sind zwei paarige und symmetrische Schleimmuskeln . Sie entspringen dem Uterushorn mit dem intramuralen Teil und setzen sich seitlich mit dem isthmischen, ampullären und infundibulären Teil fort<br> <i>Funktion:</i> Der Zweck der Eileiter besteht darin, die vom Eierstock produzierte Eizelle zu sammeln und sie in die Gebärmutter zu leiten, wo die Befruchtung stattfinden kann.</p>"
	},
	"Organo_VAGINA": {
		"Titolo": "Vagina",
		"Descrizione": "<p><i>Lage:</i> Die Vagina ist ein elastischer Muskelkanal, der sich vom Gebärmutterhals bis zum Vestibül erstreckt. Oben verbindet sich die Vagina mit dem Gebärmutterhals, während sie nch unten durch den Beckenboden verläuft und in den Vorhof der Vulva mündet<br> <i>Funktion:</i> Die Hauptfunktionen der Vagina sind: Sie dient als Durchgang zur Beseitigung des Monatsblutungs, nimmt den männlichen Penis beim Verbindung auf und leitet die Spermium in Richtung der Gebärmutter und stellt den letzten Teil des Geburtskanals dar.</p>"
	},
	"Organo_OVAIE": {
		"Titolo": "Eierstöcke",
		"Descrizione": "<p><i>Lage:</i> Im Becken auf beiden Seiten der Gebärmutter befinden sich zwei Eierstöcke ähnlich als einer Bohne in einer Region, die als ovarial Höhl bezeichnet wird<br> <i>Funktion:</i> Ihre Aufgabe ist es, Eizellen, die weiblichen Gameten und die weiblichen Sexualhormone Östrogene und Progesteron abzusondern.</p>"
	},
	"Organo_DOTTI_DEFERENTI": {
		"Titolo": "Samenleiter",
		"Descrizione": "<p><i>Lage:</i> Der Samenleiter oder Ductus deferens beginnt am Ende des Nebenhodens und beeendet, nachdem er den Leistenkanal durchquert und durch die Beckenhöhle verlaufen ist, an der Basis der Prostata, wo er sich mit der homolateralen Samenblase verbindet und die Samenblase bildet Ejakulationskanal<br> <i>Funktion:</i> Sie verbinden den Nebenhoden mit der Harnröhre, um die Samenflüssigkeit von den Hoden zum Penis zu transportieren.</p>"
	},
	"Organo_PROSTATA": {
		"Titolo": "Prostata",
		"Descrizione": "<p><i>Lage:</i> Die Prostata liegt direkt unterhalb der Blase<br> <i>Funktion:</i> Die Funktion der Prostata besteht darin, Prostataflüssigkeit zu produzieren und zu speichern.</p>"
	},
	"Organo_VESCICOLE_SEMINALI": {
		"Titolo": "Samenblasen",
		"Descrizione": "<p><i>Lage:</i> Dabei handelt es sich um paarweise angeordnete Organe oberhalb der Prostata, eines auf jeder Seite<br> <i>Funktion:</i> Ihre Aufgabe besteht darin, eine leimig Substanz abzusondern, die zusammen mit den von den Hoden produzierten Sperma und einem komplexen Sekret aus der Prostata und den Harnhörendrüsen den Sperma bildet.</p>"
	},
	"Organo_PENE": {
		"Titolo": "Penis",
	...
	"Organo_EPIDIDIMIO": {
		"Titolo": "Nebenhoden",
		"Descrizione": "<p><i>Lage:</i> Der Nebenhoden ist am oberen hinteren Rand des Hodens befestigt. Das vordere Ende ist mit dem Hoden verbunden, während das hintere Ende mit dem Hauptexkretorkanal fortfährt. Der Zwischenteil oder Körper ist durch ein Divertikel vom Hoden getrennt<br> <i>Funktion:</i> Der Nebenhoden ist für die Reifung der Sperma und deren Weiterleitung zum homolateralen Samenleiter verantwortlich, mit dem er verbunden ist.</p>"
	},
	"Organo_TESTICOLI": {
		"Titolo": "Hoden",
	...
	"Organo_URETRA": {
		"Titolo": "Harnröhre",
		"Descrizione": "<p><i>Lage (männlich):</i> Die männliche Harnröhre ist die Harnröhre bei Männern. Es handelt sich um einen muskelmembranartig Kanal, der normalerweise etwa 20 Zentimeter lang ist und seinen Ursprung in der Blase hat, durch die Prostata verläuft, intern durch die gesamte Länge des Penis verläuft und an der Spitze der Eichel endet und durch den Harngang mündet<br><i>Lage (weiblich):</i> Die weibliche Harnröhre ist die Harnröhre bei Frauen. Es handelt sich um einen muskelmembranartig Kanal, typischerweise etwa 4 bis 5 Zentimeter lang, der vom Blasenhals ausgeht, den Beckenboden durchquert und den Vulvarvestibul erreicht, wo er sich durch den Harngang nach außen öffnet<br> <i>Funktion (männlich):</i> Die männliche Harnröhre dient als anatomischer Kanal für die Blasenentleerung und den Samenausstoß<br> <i>Funktion (weiblich):</i> Die weibliche Harnröhre ist ein Abschnitt des Harnsystems, der für den endgültigen Urinabgang beim Wasserlassen verantwortlich ist.</p>"
	},
	"Organo_CISTIFELLEA": {
		"Titolo": "Gallenblase",
		"Descrizione": "<p><i>Lage:</i> Die Gallenblase befindet sich unterhalb der Leber im rechten Oberbauch, insbesondere im vorderen Teil des rechten sagittale Falte (zystische Falte) auf der unteren Oberfläche der Leber. Es liegt zwischen der 9. und 10. Rippe sowie zwischen den Wirbeln D12 und L2<br> <i>Funktion:</i> Die Funktion der Gallenblase besteht darin, die von der Leber produzierte Galle zu speichern und zu konzentrieren und sie in den Dünndarm abzugeben, um die Fettverdauung zu unterstützen.</p>"
	},
	"Organo_PANCREAS": {
		"Titolo": "Pankreas",
		"Descrizione": "<p><i>Lage:</i> Die Bauchspeicheldrüse besteht aus drei verschiedenen Teilen. Die Spitze, der größte und dickste Teil, hat Kontakt zum Zwölffingerdarm. Der von unten nach oben leicht schräge Körper ist das Zwischensegment und liegt vor der Aorta und der Hohlvene. Der Schwanz der Bauchspeicheldrüse steht in Kontakt mit der Milz und stellt den verjüngten Endabschnitt dar<br> <i>Funktion:</i> Die Bauchspeicheldrüse hat eine doppelte Funktion: endokrine und exokrine. Die endokrine Funktion bezieht sich auf seine Fähigkeit, die von ihm synthetisierten Hormone in den Blutkreislauf abzusondern, während die exokrine Funktion die Produktion von Verdauungsenzymen umfasst, die in den Verdauungstrakt abgegeben werden.</p>"
	},
	"Organo_RENI": {
		"Titolo": "Nieren",
	...
	"Organo_ESOFAGO": {
		"Titolo": "Speiseröhre",
		"Descrizione": "<p><i>Lage:</i> Die Speiseröhre ist ein Organ, das unterhalb der Luftröhre liegt und durch das Brustbein geschützt ist. Es besteht aus dehnbaren Gewebe, das sich je nach Vorhandensein oder Fehlen eines Nahrungsbolus erweitert und verengt<br> <i>Funktion:</i> Seine Funktion besteht darin, die Mundhöhle mit dem Magen zu verbinden. Im Inneren der Speiseröhre wird der Bolus durch einen feinen Mechanismus der Muskelkontraktion nach unten getrieben, wodurch eine Peristaltik der Speiseröhre entsteht.</p>"
	},
	"Organo_LARINGE": {
		"Titolo": "Kehlkopf",
