var DB_anatomia = {
    ...
    "Osso_ATLANTE": {
        "Titolo": "Atlas",
        "Descrizione": "<p>In anatomy, the atlas (C1) is the first cervical vertebra of the vertebral column. Its name is derived from the mythological Atlas, as it supports the head like a globe.</p><p><i>Location:</i> It articulates with the occipital bone and has its own characteristics. It lacks a vertebral body, which is fused with that of the second vertebra to form the odontoid process.<br><i>Action:</i> The atlas, along with the axis, forms the joint that connects the skull to the vertebral column. The atlas and axis are adapted to allow a greater degree of mobility compared to other vertebrae.<br><i>Classification:</i> Short bones.</p>"
    },
    "Osso_EPISTROFEO": {
        "Titolo": "Axis",
        "Descrizione": "<p>With its origin on the external side of the vertebral arch, halfway between the two pedicles, the spinous process of the axis is a large bony projection that bifurcates at a certain point in its lower portion, giving rise to a groove.</p><p><i>Location:</i> The axis is located between the atlas (first cervical vertebra), superiorly, and the third cervical vertebra, inferiorly.<br><i>Action:</i> Thanks to the odontoid process, the axis acts as a pivot for the atlas, allowing greater flexibility in rotating the neck and head.<br><i>Classification:</i> Short bones.</p>"
    },
    ...
    "Muscolo_FRONTALE": {
        ...
        "Descrizione": "<p><i>Origin (occipital): </i>occipital bone, mastoid process of temporal bone<br /><i>Insertion (occipital): </i>galea aponeurotica<br /><i>Origin (frontal): </i>galea aponeurotica<br /><i>Insertion (frontal): </i>skin and fascia above the eyes and nose<br /><i>Action (occipital): </i>draws back the scalp, wrinkles the forehead, and raises the eyebrows<br /><i>Action (frontal): </i>draws forward the scalp, raises the eyebrows, and wrinkles the forehead horizontally<br /><i>Innervation:</i> facial nerve VII<br /><i>Vasculature: </i>occipital artery</p>",
        "baseImg": true
    },
    "Muscolo_OCCIPITALE": {
        "Titolo": "Epicranius Muscle (occipitofrontalis)",
        "Descrizione": "<i>Origin (occipital): </i>occipital bone, mastoid process of temporal bone<br /><i>Insertion (occipital): </i>galea aponeurotica<br /><i>Origin (frontal): </i>galea aponeurotica<br /><i>Insertion (frontal): </i>skin and fascia above the eyes and nose<br /><i>Action (occipital): </i>draws back the scalp, wrinkles the forehead, and raises the eyebrows<br /><i>Action (frontal): </i>draws forward the scalp, raises the eyebrows, and wrinkles the forehead horizontally<br /><i>Innervation:</i> facial nerve VII<br /><i>Vasculature: </i>occipital artery",
        "baseImg": true
    },
    "Muscolo_ORBICOLARE_DELL_OCCHIO": {
        "Titolo": "Orbicularis Oculi Muscle",
        "Descrizione": "<i>Origin:</i> frontal bone, maxillary bone, and lacrimal bone<br /><i>Insertion:</i> encircles the orbit<br /><i>Action: </i>closes the eyelids and tightens the eye<br /><i>Innervation: </i>facial nerve VII<br /><i>Vasculature: </i>ophthalmic artery",
        "baseImg": true
    },
    "Muscolo_MASSETERE": {
        "Titolo": "Masseter Muscle",
        "Descrizione": "<i>Origin:</i> zygomatic bone<br /><i>Insertion: </i>mandibular bone<br /><i>Action: </i>protrudes and elevates the mandible<br /><i>Innervation: </i>trigeminal nerve<br /><i>Vasculature: </i>facial artery",
        "baseImg": true
    },
    "Muscolo_TEMPORALE": {
        "Titolo": "Temporal Muscle",
        "Descrizione": "<i>Origin: </i>temporal bone, parietal bone, and frontal bone<br /><i>Insertion: </i>coronoid process and anterior border of mandibular bone<br /><i>Action: </i>closes the mandible and controls its lateral movements<br /><i>Innervation: </i>trigeminal nerve<br /><i>Vasculature: </i>deep temporal artery (anterior and posterior branches)",
        "baseImg": true
    },
    "Muscolo_DIGASTRICO": {
        "Titolo": "Digastric Muscle",
        "Descrizione": "<i>Origin (anterior belly):</i> inner lower edge of mandible<br /><i>Origin (posterior belly): </i>mastoid process of temporal bone<br /><i>Insertion: </i>hyoid bone<br /><i>Action:</i> elevates the hyoid bone, depresses and retracts the mandible<br /><i>Innervation: </i>mylohyoid nerve (trigeminal V) and facial nerve VII<br /><i>Vasculature: </i>occipital artery",
        "baseImg": true
    },
    "Muscolo_SCALENI": {
        "Titolo": "Scalene Muscles",
        "Descrizione": "<i>Origin:</i> transverse processes of cervical vertebrae<br /><i>Insertion (anterior and middle scalene):</i> 1st rib<br /><i>Insertion (posterior scalene):</i> 2nd rib<br /><i>Action:</i> flexion of the neck, elevation of the 1st rib during deep inspiration, lateral flexion, and rotation of the neck<br /><i>Innervation: </i>anterior branches of cervical nerves C3-C8<br /><i>Vasculature: </i>inferior thyroid artery",
        "baseImg": true
    },
    "Muscolo_STERNOCLEIDOMASTOIDEO": {
        "Titolo": "Sternocleidomastoid Muscle",
        "Descrizione": "<i>Origin (sternal head): </i>manubrium of sternum<br /><i>Origin (clavicular head):</i> medial third of clavicle<br /><i>Insertion: </i>mastoid process of temporal bone, occipital bone<br /><i>Action (bilateral):</i> flexion of the neck, protraction of the head, and elevation of the sternum and ribs during inspiration<br /><i>Action (unilateral): </i>ipsilateral inclination and contralateral rotation of the head<br /><i>Innervation: </i>accessory nerve XI<br /><i>Vasculature: </i>superior thyroid artery",
        "baseImg": true
    },
    "Muscolo_SPLENIO_DELLA_TESTA": {
        "Titolo": "Splenius Capitis Muscle",
        "Descrizione": "<i>Origin:</i> spinous processes of C7 to T4 vertebrae and lower part of nuchal ligament<br /><i>Insertion: </i>mastoid process of temporal bone, lateral superior nuchal line<br /><i>Action (bilateral): </i>extension of the head and neck<br /><i>Action (unilateral):</i> lateral inclination and rotation of the neck<br /><i>Innervation: </i>inferior middle cervical nerves posterior branches<br /><i>Vasculature: </i>deep cervical artery",
        "baseImg": true
    },
    "Muscolo_OBLIQUO_ESTERNO": {
        "Titolo": "External Oblique Muscle",
        "Descrizione": "<i>Origin: </i>ribs 5th to 12th<br /><i>Insertion: </i>anterior part of iliac crest and linea alba<br /><i>Action: </i>lateral flexion of the trunk, compression of the abdomen, and rotation of the trunk<br /><i>Innervation: </i>anterior branches of lower intercostal nerves and subcostal nerve<br /><i>Vasculature: </i>inferior epigastric artery",
        "baseImg": true
    },
    "Muscolo_RETTO_DELL_ADDOME": {
        "Titolo": "Rectus Abdominis Muscle",
        "Descrizione": "<i>Origin:</i> pubic symphysis and pubic crest<br /><i>Insertion:</i> xiphoid process, costal cartilages 5th to 7th<br /><i>Action:</i> trunk flexion and postural stabilization during walking<br /><i>Innervation:</i> spinal nerve (T5-T12) ventral ramus<br /><i>Vasculature:</i> inferior epigastric artery",
        "baseImg": true
    },
    "Muscolo_GRANDE_PSOAS": {
        "Titolo": "Psoas Major Muscle",
        "Descrizione": "<i>Origin:</i> transverse processes and vertebral bodies from L1 to L5, bodies of T12 to L5<br /><i>Insertion:</i> lesser trochanter of femur<br /><i>Action:</i> hip flexion, thigh flexion and lateral rotation, trunk flexion with fixed insertion<br /><i>Innervation:</i> lumbar nerves (L1-L4)<br /><i>Vasculature:</i> iliolumbar artery",
        "baseImg": true
    },
    "Muscolo_ILEO": {
        "Titolo": "Iliacus Muscle",
        "Descrizione": "<i>Origin:</i> inner surface of iliac bone<br /><i>Insertion:</i> lesser trochanter of femur<br /><i>Action:</i> hip flexion, thigh flexion and lateral rotation, trunk flexion with fixed insertion<br /><i>Innervation:</i> femoral nerve (L1-L4)<br /><i>Vasculature:</i> medial circumflex femoral artery",
        "baseImg": true
    },
    "Muscolo_TRAPEZIO": {
        "Titolo": "Trapezius Muscle",
        "Descrizione": "<i>Origin:</i> superior nuchal line, occipital bone, nuchal ligament, spinous processes and supraspinous ligaments from C7 to T12<br /><i>Insertion:</i> posterior margin of clavicle, acromion, spine of scapula<br /><i>Action:</i> elevation of scapula, adduction of scapula, depression of scapula against resistance, scapular rotation<br /><i>Innervation:</i> accessory nerve<br /><i>Vasculature:</i> superficial cervical artery",
        "baseImg": true
    },
    "Muscolo_ELEVATORE_DELLA_SCAPOLA": {
        "Titolo": "Levator Scapulae Muscle",
        "Descrizione": "<i>Origin:</i> transverse processes from C1 to C4<br /><i>Insertion:</i> medial superior border of scapula<br /><i>Action:</i> elevation and retraction of scapula<br /><i>Innervation:</i> dorsal scapular nerve, C3-C4 cervical nerves<br /><i>Vasculature:</i> dorsal scapular artery",
        "baseImg": true
    },
    "Muscolo_DENTATO_ANTERIORE": {
        "Titolo": "Serratus Anterior Muscle",
        "Descrizione": "<i>Origin:</i> ribs 1st to 9th<br /><i>Insertion:</i> scapula, medial border and lower angle<br /><i>Action:</i> scapular rotation with arm abduction and flexion, protraction of scapula<br /><i>Innervation:</i> long thoracic nerve (C5-C7)<br /><i>Vasculature:</i> lateral thoracic artery",
        "baseImg": true
    },
    "Muscolo_PETTORALE": {
        "Titolo": "Pectoralis Major Muscle",
        "Descrizione": "<i>Origin:</i> anterior margin of clavicle, anterior surface of sternum, costal cartilages 1st to 6th<br /><i>Insertion:</i> crest of greater tubercle and lateral lip of bicipital groove of humerus<br /><i>Action:</i> horizontal and oblique adduction of arm, flexion and medial rotation of shoulder<br /><i>Innervation:</i> lateral pectoral nerve (C5-C7), medial pectoral nerves (C6-T1)<br /><i>Vasculature:</i> pectoral branch of thoracoacromial artery",
        "baseImg": true
    },
    "Muscolo_GRAN_DORSALE": {
        "Titolo": "Latissimus Dorsi Muscle",
        "Descrizione": "<i>Origin:</i> spinous processes of vertebrae from T7 to L5, sacrum, scapula, iliac crest, thoracolumbar fascia, ribs 9th to 12th<br /><i>Insertion:</i> humerus, intertubercular groove<br /><i>Action:</i> adduction, retroversion, and medial rotation of humerus, lateral flexion of trunk<br /><i>Innervation:</i> thoracodorsal nerve, C6-C8 branches<br /><i>Vasculature:</i> thoracodorsal artery",
        "baseImg": true
    },
    "Muscolo_DELTOIDE": {
        "Titolo": "Deltoid Muscle",
        "Descrizione": "<i>Origin (anterior head):</i> clavicle, lateral third<br /><i>Origin (middle head):</i> acromion<br /><i>Origin (posterior head):</i> spine of scapula<br /><i>Insertion:</i> humerus, deltoid tuberosity<br /><i>Action (anterior head):</i> internal rotation and flexion of humerus<br /><i>Action (middle head):</i> abduction of humerus<br /><i>Action (posterior head):</i> external rotation and extension of humerus<br /><i>Innervation:</i> axillary nerve C5-C6<br /><i>Vasculature:</i> posterior circumflex humeral artery",
        "baseImg": true
    },
    "Muscolo_INFRASPINATO": {
        "Titolo": "Infraspinatus Muscle",
        "Descrizione": "<i>Origin:</i> scapula, infraspinous fossa, posterior aspect<br /><i>Insertion:</i> humerus, greater tubercle<br /><i>Action:</i> lateral rotation of humerus and joint stabilization<br /><i>Innervation:</i> suprascapular nerve C5-C6<br /><i>Vasculature:</i> suprascapular artery, circumflex scapular artery",
        "baseImg": true
    },
    "Muscolo_PICCOLO_ROTONDO": {
        "Titolo": "Teres Minor Muscle",
        "Descrizione": "<i>Origin:</i> scapula, lateral border<br /><i>Insertion:</i> humerus, greater tubercle<br /><i>Action:</i> external lateral rotation of humerus<br /><i>Innervation:</i> axillary nerve C5-C6<br /><i>Vasculature:</i> circumflex scapular artery",
        "baseImg": true
    },
    "Muscolo_GRANDE_ROTONDO": {
        "Titolo": "Teres Major Muscle",
        "Descrizione": "<i>Origin:</i> scapula, inferior angle<br /><i>Insertion:</i> humerus, intertubercular groove<br /><i>Action:</i> retroversion and adduction of humerus<br /><i>Innervation:</i> subscapular nerve<br /><i>Vasculature:</i> circumflex scapular artery",
        "baseImg": true
    },
    ...
    "Muscolo_OPPONENTE_POLLICE": {
        ...
        "Descrizione": "<i>Origine: </i>Scaphoid bone, trapezium bone, and flexor retinaculum.<br /><i>Inserzione: </i>First metacarpal bone, lateral surface.<br /><i>Azione: </i>Thumb opposition.<br /><i>Innervazione: </i>Median nerve C8-T1.<br /><i>Vascolarizzazione: </i>Radial artery.",
        "baseImg": true
    },
    ...
    "Muscolo_PROCERO": {
        ...
        "Descrizione": "<p>The Procero muscle is a facial mimic muscle located in the frontal region. Here is its description:</p>"
    },
    "Muscolo_CORRUGATORE": {
        "Titolo": "Corrugator Muscle",
        "Descrizione": "<p>The Corrugator muscle is a facial muscle that originates at the medial end of the eyebrow arch and inserts deep into the skin above the center of the orbital arch. Its action is to furrow the forehead.</p>"
    },
    "Muscolo_BUCCINATORE": {
        "Titolo": "Buccinator Muscle",
        "Descrizione": "<p>The Buccinator muscle originates from the pterygomandibular raphe and surrounding bony structures. It inserts into the orbicularis oris muscle at the corner of the mouth. Its action is to flatten the cheeks and pull back the corner of the lips laterally.</p>"
    },
    "Muscolo_ZIGOMATICO": {
        "Titolo": "Zygomatic Muscle",
        "Descrizione": "<p>The Zygomatic muscle is divided into three portions: zygomatic, infraorbital, and angular. It originates from the facial surface of the zygomatic bone and inserts into the temporal fascia. Its action is involved in chewing and facial expression.</p>"
    },
    "Muscolo_ELEVATORE_DEL_LABBRO": {
        "Titolo": "Lip Elevator Muscle",
        "Descrizione": "<p>The Lip Elevator muscle consists of three portions: zygomatic, infraorbital, and angular. The zygomatic portion originates from the lateral surface of the zygomatic bone and inserts into the upper lip skin above the commissure. The infraorbital portion originates from the infraorbital margin and inserts into the medial side of the upper lip, near the termination of the zygomatic portion. The angular portion originates from the frontal process of the maxilla and the nasal bone, and inserts into the skin of the nostril wing and upper lip. Its action involves lifting the upper lip and the wing of the nose when contracted.</p>"
    },
    "Muscolo_RISORIO": {
        "Titolo": "Risorius Muscle",
        "Descrizione": "<p>The Risorius muscle originates from the parotid fascia and extends anteriorly to the corner of the mouth. Its insertion is deep into the skin. The Risorius muscle is responsible for pulling back the angle of the mouth, playing a role in smiling and laughter.</p>"
    },
    "Muscolo_CORACOBRACHIALE": {
        "Titolo": "Coracobrachialis Muscle",
        "Descrizione": "<p>The Coracobrachialis muscle originates from the apex of the coracoid process of the scapula, sharing its origin with the short head of the biceps muscle. It inserts on the mid-third of the anteromedial surface of the humerus, deep and medial to the short head of the triceps brachii muscle. Its action is to flex and adduct the arm and helps maintain the head of the humerus in its natural position.</p>"
    },
    "Muscolo_BRACHIALE": {
        "Titolo": "Brachialis Muscle",
        "Descrizione": "<p>The Brachialis muscle originates on the distal half of the anterior surface of the humerus, below the deltoid insertion, and on the intermuscular septa. It inserts on the ulnar tuberosity and the joint capsule. Its action is to flex the elbow in synergy with the biceps brachii muscle. The Brachialis muscle is innervated by the musculocutaneous nerve, with a small lateral portion also innervated by the radial nerve.</p>"
    },
    "Muscolo_ANCONEO": {
    ...
    "Organo_MAMMELLE": {
        "Titolo": "Breasts",
        "Descrizione": "<p><i>Location:</i> They are located on the anterior thoracic wall in the pectoral region. The breasts are a paired organ consisting of two symmetrical and prominent structures.<br><br>The breasts are composed of glandular tissue, a series of ducts, adipose tissue, and other supportive tissues.<br><i>Function:</i> The main function of each breast is associated with lactation. Physiologically, breasts are accessory glands of the female reproductive system.</p>"
    },
    ...
    "Organo_PROSTATA": {
        "Titolo": "Prostate",
        "Descrizione": "<p><i>Location:</i> The prostate gland lies just below the bladder.<br><i>Function:</i> The prostate gland's function is to produce and store prostatic fluid.</p>"
    },
