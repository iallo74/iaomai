...
///----------------------------
		...
		features: {
			ita: "<h2>Benvenuto nella versione 1.6</h2><p class=\"descr\">Abbiamo cambiato alcune caratteristiche dell'applicazione al fine di renderla sempre più ricca di contenuto, facile e intuitiva da usare e veloce.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>Divisione in moduli</b><br> Dalla versione 1.6 le mappe tematiche verranno divise in moduli. La prima mappa a subire il cambiamento è ShiatsuMap, che è stata divisa in 4 moduli distinti e acquistabili separatamente:<br />  - ShiatsuMap PRO Cinesi<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Correzioni ai testi</b><br>  Sono state apportate alcune correzioni ai testi nelle varie lingue.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Miglioramenti</b><br>Sono stati effettuati miglioramenti di vario genere e corretti alcuni bugs presenti nella versione precedente.</div></div>",
			eng: "<h2>Welcome to version 1.6</h2><p class=\"descr\">We have changed some features of the application in order to make it richer in content, easy and intuitive to use, and fast.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>Division into modules</b><br> From version 1.6, thematic maps will be divided into modules. The first map to undergo the change is ShiatsuMap, which has been divided into 4 distinct modules that can be purchased separately:<br />  - ShiatsuMap PRO Chinese<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Text corrections</b><br>  Some text corrections have been made in various languages.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Improvements</b><br>Various improvements have been made and some bugs present in the previous version have been corrected.</div></div>",
			esp: "<h2>Bienvenido a la versión 1.6</h2><p class=\"descr\">Hemos cambiado algunas características de la aplicación para hacerla más rica en contenido, fácil e intuitiva de usar y rápida.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>División en módulos</b><br> A partir de la versión 1.6, los mapas temáticos se dividirán en módulos. El primer mapa en sufrir el cambio es ShiatsuMap, que se ha dividido en 4 módulos distintos que se pueden adquirir por separado:<br />  - ShiatsuMap PRO Chino<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Correcciones de texto</b><br>  Se han realizado algunas correcciones de texto en varios idiomas.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Mejoras</b><br>Se han realizado mejoras de varios tipos y se han corregido algunos errores presentes en la versión anterior.</div></div>",
			fra: "<h2>Bienvenue dans la version 1.6</h2><p class=\"descr\">Nous avons modifié certaines caractéristiques de l'application afin de la rendre toujours plus riche en contenu, facile et intuitive à utiliser et rapide.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>Division en modules</b><br> À partir de la version 1.6, les cartes thématiques seront divisées en modules. La première carte à subir le changement est ShiatsuMap, qui a été divisée en 4 modules distincts pouvant être achetés séparément :<br />  - ShiatsuMap PRO Chinois<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Corrections de texte</b><br>  Certaines corrections de texte ont été apportées dans différentes langues.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Améliorations</b><br>Diverses améliorations ont été apportées et certains bugs présents dans la version précédente ont été corrigés.</div></div>",
			por: "<h2>Bem-vindo à versão 1.6</h2><p class=\"descr\">Mudamos algumas características da aplicação para torná-la cada vez mais rica em conteúdo, fácil e intuitiva de usar e rápida.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>Divisão em módulos</b><br> A partir da versão 1.6, os mapas temáticos serão divididos em módulos. O primeiro mapa a sofrer a mudança é o ShiatsuMap, que foi dividido em 4 módulos distintos que podem ser adquiridos separadamente:<br />  - ShiatsuMap PRO Chinês<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Correções de texto</b><br>  Foram feitas algumas correções de texto em vários idiomas.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Melhorias</b><br>Foram feitas melhorias de vários tipos e corrigidos alguns erros presentes na versão anterior.</div></div>",
			deu: "<h2>Willkommen in Version 1.6</h2><p class=\"descr\">Wir haben einige Funktionen der Anwendung geändert, um sie immer inhaltsreicher, einfach und intuitiv zu bedienen und schnell zu machen.</p><div><div><img src=\"img/ico_puzzleN.png\" width=\"30\" style=\"    margin-left: 11px;\"></div><div><b>Aufteilung in Module</b><br> Ab Version 1.6 werden thematische Karten in Module unterteilt. Die erste Karte, die die Änderung erfährt, ist ShiatsuMap, die in 4 verschiedene Module unterteilt wurde, die separat erworben werden können:<br />  - ShiatsuMap PRO Chinesisch<br />- ShiatsuMap PRO Masunaga<br />- ShiatsuMap PRO Namikoshi<br />- ShiatsuMap Light</div></div><div><div><img src=\"img/ico_linguaprefN.png\" width=\"32\" height=\"36\" style=\"margin-left:9px;\"></div><div><b>Textkorrekturen</b><br>  Es wurden einige Textkorrekturen in verschiedenen Sprachen vorgenommen.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div>"
        }              
    },
    set: {}
}
