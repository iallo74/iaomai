...
///----------------------------
		...
		features: {
			ita: "<h2>Benvenuto nella versione 1.8</h2><p class=\"descr\">Abbiamo cambiato alcune caratteristiche dell'applicazione al fine di renderla sempre più ricca di contenuto, facile e intuitiva da usare e veloce.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>Diagnosi con l’intelligenza artificiale</b><br>La tecnologia AI ti supporta con suggerimenti avanzati per analisi più rapide e accurate. Una nuova frontiera per la tua pratica.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Moduli di valutazione specifici</b><br>Ora puoi utilizzare strumenti dedicati per la <i>valutazione del dolore</i>, le <i>4 diagnosi MTC</i> e la <i>valutazione energetica nello Shiatsu</i> direttamente nelle schede di trattamento, per un approccio ancora più completo e personalizzato.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>Nuovo sistema di abbonamento</b><br>Accedi alle nostre mappe tematiche con un piano flessibile in abbonamento, a scelta mensile o annuale.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Fix e ottimizzazioni</b><br>Prestazioni ottimizzate e maggiore stabilità per un’esperienza impeccabile.</div></div>",
			eng: "<h2>Welcome to version 1.8</h2><p class=\"descr\">We have changed some features of the application to make it richer in content, easier and more intuitive to use, and faster.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>AI-powered diagnosis</b><br>The AI technology supports you with advanced suggestions for faster and more accurate analysis. A new frontier for your practice.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Specific assessment modules</b><br>You can now use dedicated tools for <i>pain assessment</i>, the <i>4 MTC diagnoses</i>, and <i>energy evaluation in Shiatsu</i> directly in the treatment sheets, for an even more comprehensive and personalized approach.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>New subscription system</b><br>Access our thematic maps with a flexible subscription plan, available on a monthly or yearly basis.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Fixes and optimizations</b><br>Optimized performance and increased stability for a flawless experience.</div></div>",
			esp: "<h2>Bienvenido a la versión 1.8</h2><p class=\"descr\">Hemos cambiado algunas características de la aplicación para hacerla más rica en contenido, más fácil e intuitiva de usar y más rápida.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>Diagnóstico con inteligencia artificial</b><br>La tecnología de IA te apoya con sugerencias avanzadas para análisis más rápidos y precisos. Una nueva frontera para tu práctica.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Módulos de evaluación específicos</b><br>Ahora puedes utilizar herramientas dedicadas para la <i>evaluación del dolor</i>, los <i>4 diagnósticos MTC</i> y la <i>evaluación energética en Shiatsu</i> directamente en las fichas de tratamiento, para un enfoque aún más completo y personalizado.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>Nuevo sistema de suscripción</b><br>Accede a nuestros mapas temáticos con un plan de suscripción flexible, disponible mensualmente o anualmente.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Correcciones y optimizaciones</b><br>Rendimiento optimizado y mayor estabilidad para una experiencia impecable.</div></div>",
			fra: "<h2>Bienvenue dans la version 1.8</h2><p class=\"descr\">Nous avons modifié certaines fonctionnalités de l'application afin de la rendre plus riche en contenu, plus facile et intuitive à utiliser, et plus rapide.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>Diagnostic avec intelligence artificielle</b><br>La technologie IA vous assiste avec des suggestions avancées pour une analyse plus rapide et plus précise. Une nouvelle frontière pour votre pratique.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Modules d’évaluation spécifiques</b><br>Vous pouvez désormais utiliser des outils dédiés pour l’<i>évaluation de la douleur</i>, les <i>4 diagnostics MTC</i> et l’<i>évaluation énergétique en Shiatsu</i> directement dans les fiches de traitement, pour une approche encore plus complète et personnalisée.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>Nouveau système d’abonnement</b><br>Accédez à nos cartes thématiques avec un abonnement flexible, disponible au mois ou à l’année.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Corrections et optimisations</b><br>Performances optimisées et stabilité accrue pour une expérience impeccable.</div></div>",
			por: "<h2>Bem-vindo à versão 1.8</h2><p class=\"descr\">Fizemos algumas alterações no aplicativo para torná-lo mais rico em conteúdo, mais fácil e intuitivo de usar e mais rápido.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>Diagnóstico com inteligência artificial</b><br>A tecnologia de IA apoia você com sugestões avançadas para análises mais rápidas e precisas. Uma nova fronteira para sua prática.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Módulos de avaliação específicos</b><br>Agora você pode usar ferramentas dedicadas para a <i>avaliação da dor</i>, os <i>4 diagnósticos MTC</i> e a <i>avaliação energética no Shiatsu</i> diretamente nas fichas de tratamento, para uma abordagem ainda mais completa e personalizada.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>Novo sistema de assinatura</b><br>Acesse nossos mapas temáticos com um plano de assinatura flexível, mensal ou anual.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Correções e otimizações</b><br>Desempenho otimizado e maior estabilidade para uma experiência impecável.</div></div>",
			deu: "<h2>Willkommen in Version 1.8</h2><p class=\"descr\">Wir haben einige Funktionen der Anwendung geändert, um sie inhaltlich noch reicher, einfacher und intuitiver zu bedienen und schneller zu machen.</p><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b>Diagnose mit künstlicher Intelligenz</b><br>Die KI-Technologie unterstützt dich mit fortschrittlichen Vorschlägen für schnellere und genauere Analysen. Eine neue Grenze für deine Praxis.</div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b>Spezifische Bewertungsmodule</b><br>Jetzt kannst du spezielle Werkzeuge für die <i>Schmerzeinschätzung</i>, die <i>4 MTC-Diagnosen</i> und die <i>energetische Bewertung im Shiatsu</i> direkt in den Behandlungsblättern nutzen, für einen noch umfassenderen und individuelleren Ansatz.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b>Neues Abonnement-System</b><br>Greife mit einem flexiblen Abonnementplan auf unsere thematischen Karten zu, monatlich oder jährlich.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b>Fehlerbehebungen und Optimierungen</b><br>Optimierte Leistung und erhöhte Stabilität für eine einwandfreie Erfahrung.</div></div>"
        }              
    },
    set: {}
}
