DB.TXT = {
    base: {
        ...
        DatiPaziente: {
            ita: "Dati paziente",
            eng: "Patient data",
            esp: "Datos del paciente",
            fra: "Données du patient",
        ...
        DatiPazienteShiatsu: {
            ita: "Dati ricevente",
            eng: "Recipient data",
            esp: "Datos del receptor",
            fra: "Données du receveur",
            por: "Dados do receptor",
            deu: "Empfängerdaten"
        },
        Anamnesi: {
            ita: "Anamnesi",
...
///----------------------------
		...
		features: { 
			ita: "<h2>Benvenuto nella versione 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">Diagnosi con l’intelligenza artificiale</b><br>La tecnologia AI ti supporta con suggerimenti avanzati per analisi più rapide e accurate. Una nuova frontiera per la tua pratica.<br><br><b>Come utilizzare la diagnosi AI</b><ul><li>Apri un paziente dal tuo archivio</li><li>Crea un trattamento e compila i dati di anamnesi, i sintomi e i moduli di valutazione</li><li>Clicca sul punsante <b style=\"color:#002999;\">Magic Diagnosi</b> che trovi nella sezione \"Diagnosi\"</li><li>Attendi il risultato e il gioco è fatto!</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Moduli di valutazione specifici</b><br>Ora puoi utilizzare strumenti dedicati per la <i>valutazione del dolore</i>, le <i>4 diagnosi MTC</i> e la <i>valutazione energetica nello Shiatsu</i> direttamente nelle schede di trattamento, per un approccio ancora più completo e personalizzato.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Nuovo sistema di abbonamento</b><br>Accedi alle nostre mappe tematiche con un piano flessibile in abbonamento, a scelta mensile o annuale.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Fix e ottimizzazioni</b><br>Prestazioni ottimizzate e maggiore stabilità per un’esperienza impeccabile.</div></div>",
			eng: "<h2>Welcome to version 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">AI-Powered Diagnosis</b><br>The AI technology supports you with advanced suggestions for faster and more accurate analyses. A new frontier for your practice.<br><br><b>How to Use AI Diagnosis</b><ul><li>Open a patient from your archive</li><li>Create a treatment and fill in the anamnesis data, symptoms, and evaluation forms</li><li>Click the <b style=\"color:#002999;\">Magic Diagnosi</b> button in the \"Diagnosis\" section</li><li>Wait for the result, and you’re done!</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Specific Evaluation Forms</b><br>You can now use dedicated tools for <i>pain assessment</i>, the <i>4 MTC diagnoses</i>, and <i>energy evaluation in Shiatsu</i> directly within treatment records, for an even more complete and personalized approach.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">New Subscription System</b><br>Access our thematic maps with a flexible subscription plan, available monthly or annually.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Fixes and Optimizations</b><br>Optimized performance and greater stability for a seamless experience.</div></div>",
			esp: "<h2>Bienvenido a la versión 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">Diagnóstico con Inteligencia Artificial</b><br>La tecnología de IA te apoya con sugerencias avanzadas para análisis más rápidos y precisos. Una nueva frontera para tu práctica.<br><br><b>Cómo utilizar el diagnóstico con IA</b><ul><li>Abre un paciente desde tu archivo</li><li>Crea un tratamiento y completa los datos de anamnesis, los síntomas y los formularios de evaluación</li><li>Haz clic en el botón <b style=\"color:#002999;\">Magic Diagnosi</b> en la sección \"Diagnóstico\"</li><li>Espera el resultado, ¡y listo!</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Formularios de Evaluación Específicos</b><br>Ahora puedes utilizar herramientas dedicadas para la <i>evaluación del dolor</i>, los <i>4 diagnósticos MTC</i> y la <i>evaluación energética en Shiatsu</i> directamente en las fichas de tratamiento, para un enfoque aún más completo y personalizado.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Nuevo Sistema de Suscripción</b><br>Accede a nuestros mapas temáticos con un plan de suscripción flexible, disponible mensual o anualmente.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Correcciones y Optimización</b><br>Rendimiento optimizado y mayor estabilidad para una experiencia impecable.</div></div>",
			fra: "<h2>Bienvenue dans la version 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">Diagnostic avec l'intelligence artificielle</b><br>La technologie IA vous aide avec des suggestions avancées pour des analyses plus rapides et précises. Une nouvelle frontière pour votre pratique.<br><br><b>Comment utiliser le diagnostic IA</b><ul><li>Ouvrez un patient depuis votre archive</li><li>Créez un traitement et complétez les données d’anamnèse, les symptômes et les formulaires d’évaluation</li><li>Cliquez sur le bouton <b style=\"color:#002999;\">Magic Diagnosi</b> dans la section \"Diagnostic\"</li><li>Attendez le résultat, et c'est fait !</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Formulaires d'évaluation spécifiques</b><br>Vous pouvez désormais utiliser des outils dédiés pour <i>l'évaluation de la douleur</i>, les <i>4 diagnostics MTC</i> et <i>l'évaluation énergétique en Shiatsu</i> directement dans les fiches de traitement, pour une approche encore plus complète et personnalisée.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Nouveau système d'abonnement</b><br>Accédez à nos cartes thématiques avec un plan d'abonnement flexible, disponible mensuellement ou annuellement.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Corrections et optimisations</b><br>Performances optimisées et meilleure stabilité pour une expérience impeccable.</div></div>",
			por: "<h2>Bem-vindo à versão 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">Diagnóstico com Inteligência Artificial</b><br>A tecnologia de IA oferece suporte com sugestões avançadas para análises mais rápidas e precisas. Uma nova fronteira para sua prática.<br><br><b>Como usar o diagnóstico com IA</b><ul><li>Abra um paciente do seu arquivo</li><li>Crie um tratamento e preencha os dados de anamnese, sintomas e formulários de avaliação</li><li>Clique no botão <b style=\"color:#002999;\">Magic Diagnosi</b> na seção \"Diagnóstico\"</li><li>Aguarde o resultado, e pronto!</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Formulários de Avaliação Específicos</b><br>Agora você pode usar ferramentas dedicadas para a <i>avaliação da dor</i>, os <i>4 diagnósticos MTC</i> e a <i>avaliação energética no Shiatsu</i> diretamente nos registros de tratamento, para uma abordagem ainda mais completa e personalizada.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Novo Sistema de Assinatura</b><br>Acesse nossos mapas temáticos com um plano de assinatura flexível, disponível mensal ou anualmente.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Correções e Otimizações</b><br>Desempenho otimizado e maior estabilidade para uma experiência impecável.</div></div>",
			deu: "<h2>Willkommen in Version 1.9</h2><img src=\"img/videata-V1_9.jpg\" style=\"width:100%;margin-top:10px;\"><div><div><img src=\"img/ico_diagnosiAI.png\" width=\"40\" style=\"margin-left: 9px;\"></div><div><b class=\"tit_features\">Diagnose mit künstlicher Intelligenz</b><br>Die KI-Technologie unterstützt Sie mit fortschrittlichen Vorschlägen für schnellere und genauere Analysen. Eine neue Grenze für Ihre Praxis.<br><br><b>So verwenden Sie die KI-Diagnose</b><ul><li>Öffnen Sie einen Patienten aus Ihrem Archiv</li><li>Erstellen Sie eine Behandlung und füllen Sie die Anamnesedaten, Symptome und Bewertungsformulare aus</li><li>Klicken Sie auf die Schaltfläche <b style=\"color:#002999;\">Magic Diagnosi</b> im Abschnitt \"Diagnose\"</li><li>Warten Sie auf das Ergebnis, und fertig!</li></ul></div></div><div><div><img src=\"img/ico_anamnesi.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Spezifische Bewertungsformulare</b><br>Jetzt können Sie spezielle Tools für die <i>Schmerzbewertung</i>, die <i>4 MTC-Diagnosen</i> und die <i>Energiebewertung im Shiatsu</i> direkt in den Behandlungsunterlagen nutzen, für einen noch umfassenderen und individuelleren Ansatz.</div></div><div><div><img src=\"img/ico_abbonamenti.png\" style=\"margin-left:9px;\"></div><div><b class=\"tit_features\">Neues Abonnement-System</b><br>Greifen Sie mit einem flexiblen Abonnementplan, wahlweise monatlich oder jährlich, auf unsere thematischen Karten zu.</div></div><div><div><img src=\"img/p_impostazioniN.png\" width=\"32\" height=\"36\" style=\"margin:6px 6px 6px 11px;\"></div><div><b class=\"tit_features\">Fehlerbehebungen und Optimierungen</b><br>Optimierte Leistung und höhere Stabilität für eine einwandfreie Erfahrung.</div></div>"
        }              
    },
    set: {}
}
