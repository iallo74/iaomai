DB.TXT = {
    base: {
		...
		features: {
			ita: "<h2>Benvenuto nella versione 1.5</h2><p class=\"descr\">Abbiamo cambiato alcune caratteristiche dell'applicazione al fine di renderla sempre più ricca di contenuto, facile e intuitiva da usare e veloce.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>È disponibile da oggi la nuova mappa tematica dedicata alla Reflessologia plantare, ricca di contenuti e versatile, adatta allo studio e alla professione.</div></div><ul><li>Anatomia completa del piede con ossa, legamenti, muscoli, nervi e vasi</li><li>104 zone riflesse divise in 9 apparati/sistemi</li><li>8 proposte di trattamento</li><li>Teoria completa della Reflessologia plantare</li></ul>",
            eng: "<h2>Welcome to version 1.5</h2><p class=\"descr\">We have made some changes to the application to make it richer in content, easy and intuitive to use, and fast.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>The new thematic map dedicated to Foot Reflexology is now available, rich in content and versatile, suitable for study and profession.</div></div><ul><li>Complete foot anatomy with bones, ligaments, muscles, nerves, and vessels</li><li>104 reflex zones divided into 9 apparatus/systems</li><li>8 treatment proposals</li><li>Complete theory of Foot Reflexology</li></ul>",
            esp: "<h2>Bienvenido a la versión 1.5</h2><p class=\"descr\">Hemos realizado algunos cambios en la aplicación para hacerla más rica en contenido, fácil e intuitiva de usar y rápida.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>La nueva mapa temático dedicada a la Reflexología Podal ya está disponible, rica en contenido y versátil, adecuada para el estudio y la profesión.</div></div><ul><li>Anatomía completa del pie con huesos, ligamentos, músculos, nervios y vasos</li><li>104 zonas reflejas divididas en 9 aparatos/sistemas</li><li>8 propuestas de tratamiento</li><li>Teoría completa de la Reflexología Podal</li></ul>",
            fra: "<h2>Bienvenue à la version 1.5</h2><p class=\"descr\">Nous avons apporté quelques modifications à l'application pour la rendre plus riche en contenu, facile et intuitive à utiliser, et rapide.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>La nouvelle carte thématique dédiée à la réflexologie plantaire est maintenant disponible, riche en contenu et polyvalente, adaptée à l'étude et à la profession.</div></div><ul><li>Anatomie complète du pied avec os, ligaments, muscles, nerfs et vaisseaux</li><li>104 zones réflexes divisées en 9 appareils/systèmes</li><li>8 propositions de traitement</li><li>Théorie complète de la réflexologie plantaire</li></ul>",
            por: "<h2>Bem-vindo à versão 1.5</h2><p class=\"descr\">Fizemos algumas alterações na aplicação para torná-la mais rica em conteúdo, fácil e intuitiva de usar e rápida.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>O novo mapa temático dedicado à Reflexologia Plantar está agora disponível, rico em conteúdo e versátil, adequado para estudo e profissão.</div></div><ul><li>Anatomia completa do pé com ossos, ligamentos, músculos, nervos e vasos</li><li>104 zonas reflexas divididas em 9 aparelhos/sistemas</li><li>8 propostas de tratamento</li><li>Teoria completa da Reflexologia Plantar</li></ul>",
            deu: "<h2>Willkommen in Version 1.5</h2><p class=\"descr\">Wir haben einige Änderungen an der Anwendung vorgenommen, um sie inhaltlich reicher, einfach und intuitiv zu gestalten und schnell zu machen.</p><div><div><img src=\"sets/reflessologia_plantare/img/logoBianco.png\" class=\"logoApp\"></div><div><b>ReflexologyMap</b><br>Die neue thematische Karte zur Fußreflexzonenmassage ist ab sofort verfügbar, reichhaltig an Inhalten und vielseitig, geeignet für Studium und Beruf.</div></div><ul><li>Vollständige Fußanatomie mit Knochen, Bändern, Muskeln, Nerven und Gefäßen</li><li>104 Reflexzonen in 9 Apparaten/Systemen unterteilt</li><li>8 Behandlungsvorschläge</li><li>Komplette Theorie der Fußreflexzonenmassage</li></ul>"
        }              
    },
    set: {}
}
