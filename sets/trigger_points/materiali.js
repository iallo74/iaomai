...
SET.COL = {
	...
	PTemissive: 0x001144,//0x333300,
	PTno_emissive: 0x111100,
...
SET.MAT = {
	...
	applicaMappa: function( nPunto='' ){
		...
		if(nPunto==''){
			...
			MODELLO.MAT.materialAree[1].roughness = SET.MAT.roughnessOr;
			MODELLO.MAT.materialAree[2].roughness = SET.MAT.roughnessOr;
			MODELLO.MAT.materialAree[3].roughness = SET.MAT.roughnessOr;
		}else{
						...
						if(zona<3){
							...
							setTimeout(function(){
								for(let e=1;e<=3;e++){
									...
									MODELLO.MAT.materialAree[e].roughness = 0.9;
								}
...
SET._setLineMaterials = function(){
	SET.MAT.pointBase.color.setHex(SET.COL.basePT);
	if(SET.ptSel){
		//SET.MAT.pointBase.color.setHex(SET.COL.basePT);
		//SET.MAT.pointBase.emissive.setHex(SET.COL.PTno_emissive);
		SET.MAT.pointBase.opacity = 0.25;
	}else{
		//SET.MAT.pointBase.color.setHex(SET.COL.basePTmusc);
		//SET.MAT.pointBase.emissive.setHex(SET.COL.PTemissive);
