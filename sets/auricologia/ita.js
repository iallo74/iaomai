            ...
            "contenuti": [
                {
                    ...
                    "TestoTeoria": "La struttura del padiglione auricolare comprende:<br><br><b>La lamina cartillaginea</b><br>E' costituita da una fibrocartilagine elastica che presenta un rivestimento cutaneo. La superficie ha delle depressioni e rilevatezze, la lamina cartilaginea è connessa con parti circostanti da legamenti e muscoli.<br><br><b>I legamenti</b><br>L'orecchio è unito all'osso temporale dal legamento anteriore dal trago alla spina dell'elice, alla radice del processo zigomatico dell'osso temporale; dal legamento posteriore che unisce la superficie posteriore della conca alla superficie laterale del processo mastoideo.<br><br><b>Muscoli estrinseci</b><br>Sono il m. auricolare superiore e posteriore innervati dai rami del n. facciale.<br><br><b>Muscoli intrinseci</b><br> Sono il muscolo grande e piccolo dell'elice, del trago, antitrago, (posti sulla superficie laterale dell'orecchio esterno) i muscoli trasverso e obliquo del padiglione (situati sulla superficie mastoidea). Sono innervati da i rami del nervo facciale.<br><br><b>Vascolarizzazione</b><br>Rappresentata da rami dell'arteria auricolare posteriore e dell'arteria temporale superficiale che originano dalla carotide esterna. Le vene dell'orecchio si dividono come le arterie anteriori e posteriori che confluiscono nella vena giugulare interna.<br><br><b>La cute</b><br>La cute del padiglione auricolare è più sottile, regolare e liscia."
                },
                {
                    "TitoloTeoria": "Mappa e aree",
                    "TestoTeoria": "Per la mappatura del padiglione auricolare e la classificazione delle aree andremo ad utilizzare il microsistema elaborato da Terry Oleson nel 1983 e decretato ufficiale durante la riunione del WHO di Pechino nel 2010.<br> La reale visione anatomica 3D ha fatto sì che alcune aree, come la faccia mediale del padiglione auricolare, e alcuni riferimenti mediali ai punti laterali in transfissione, abbiano subito alcune modifiche.<br><br><b>La nomenclatura delle aree</b><br>Il padiglione auricolare è stato diviso in 19 aree, indicate qui di seguito con i rispettivi codici tra parentesi:<br>- Elice (HX)- Superficie interna dell'elice (IH)<br>- Fossa triangolare (TF)<br>- Antelice (AH)<br>- Fossa scafoide (SF)<br>- Avanmuro (CW)<br>- Emiconca superiore (SC)<br>- Emiconca inferiore (IC)<br>- Conca rigida (CR)<br>- Trago (TG)<br>- Superficie interna del trago (ST)<br>- Incisura intertragica (IT)<br>- Antitrago (AT)<br>- Lobulo (LO)<br>- Elice posteriore (PP)<br>- Solco longitudinale posteriore (PG)<br>- Eminenza triangolare posteriore (PT)<br>- Conca posteriore (PC)<br>- Lobulo posteriore (PL)<br><br>Ogni area è a sua volta divisa in settori numerati in progressione caudo-craniale e antero-posteriore.<br><br>Nella scheda di ogni punto o area, sotto la voce 'ubicazione', è indicato un codice che rappresenta l'area e il settore di uno punto (es. AH1)."
                },
                {
				...
				},
				{
					...
					"TestoTeoria": "Gli organismi vertebrati nascono a partire dall'unione di un ovulo e di uno spermatozoo: la prima cellula che si viene a formare immediatamente si divide per diventare un organismo multicellulare. Questa cellula si ripiega infine su se stessa e si suddivide in tre differenti strati di tessuto embriologico, dai quali successivamente si formano tutti gli organi. Tali organi sono proiettati su alcune regioni del padiglione auricolare.<br><br> <b>Tessuto endodermico</b><br>A partire dall'endoderma si formano il tratto digestivo gastrointestinale, il sistema respiratorio, gli organi addominali, quali fegato, pancreas, uretra e vescica; vengono inoltre generati le parti del sistema endocrino, comprese le ghiandole tiroidea, paratiroide e timo.<br>Sul padiglione auricolare, il tessuto embrionale profondo corrisponde alla conca, la zona centrale dell'orecchio. è utile stimolare questa regione dell'orecchio per le attività metaboliche, per i disturbi nutritivi degli organi interni, legati allo strato endodermico dell'embrione. Le problematiche degli organi interni sono un ostacolo per i trattamenti medici e la loro riuscita, quindi vanno corrette prima della completa guarigione.<br><br> <b>Tessuto mesodermico</b><br>Dal mesoderma si formano i muscoli scheletrici, i muscoli cardiaci, i muscoli lisci, il tessuto connettivo, le articolazioni, le ossa, le cellule del sangue dal midollo osseo, il sistema circolatorio, il sistema linfatico, la corteccia surrenale e gli organi urogenitali. <br>L'equilibrio muscolo-scheletrico viene regolato valutando la risposta negativa dei riflessi somatosensoriali. Il tessuto embrionale medio corrisponde all'antelice, alla fossa scafoide, alla fossa triangolare e alle parti dell'elice.<br>I meccanismi di difesa del corpo si attivano solo se la regione dello strato intermedio funziona correttamente.<br><br> <b>Tessuto ectodermico</b><br>Dall'ectoderma dell'embrione si genera lo strato superficiale, ovvero la pelle esterna, la cornea, il cristallino, l'epitelio nasale, i denti, i nervi periferici, il midollo spinale, il cervello, le ghiandole endocrine del midollo pituitario, pineale e surrenale.<br>Il tessuto ectodermico corrisponde al lobo dell'orecchio e alla coda dell'elice.<br>Questo strato embriologico opera sulla capacità di adattamento e contatto con l'ambiente, permette di vedere le reazioni di resistenza psicologica della mente cosciente e della psiche profonda inconscia e aggiunge alle informazioni istintive innate le esperienze personali apprese."
				}
            ],
            "noList": true
        },
