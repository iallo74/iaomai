	...
	"schede": {
		...
		9: {
			"g": {
				...
				"d": "* Per individuare la zona più sensibile utilizzare la palpazione manuale utilizzando indice e pollice e in seguito il pauper azzurro sulla superficie laterale e quello nero sulla superficie mediale. Per la detezione inizialmente si deve effettuare la manovra strisciando e in seguito premendo, fino a trovare i punti più sensibili."
			},
			"s": [
				{
					"t": "Dolore unilaterale",
        ...
        { // anatomia dell'orecchio
            ...
            "contenuti": [
				...
				},
				{
					...
					"TestoTeoria": "L'auricolopuntura deve tenere in particolare considerazione l'innervazione del padiglione auricolare. Il padiglione, infatti, è un organo fittamente innervato; si stima che possano essere presenti circa 10.000 recettori sensoriali localizzati tra epidermide e derma. I rami motori che giungono al padiglione auricolare derivano dal VII nervo facciale o faciale e sono destinati alla muscolatura intrinseca del padiglione stesso. All'innervazione del padiglione auricolare contribuiscono almeno quattro nervi che derivano da nervi cranici e spinali. Poiché l'intero padiglione auricolare è coperto da un sottile strato cutaneo contenente nervi molto ramificati, tutte le aree anatomiche dell'orecchio esterno sono in parte legate al tessuto ectodermico.<br /><br /><b>Nervo auricolotemporale</b><br />E' un ramo del nervo mandibolare del trigemino. Innerva principalmente il trago, parte dell'antitrago, la radice dell'elice, il ginocchio dell'elice e l'apice del padiglione auricolare, nonché la fossa triangolare, la radice inferiore dell'antelice e parte della radice superiore dell'antelice. Questa regione auricolare rappresenta il tessuto nervoso somatosensoriale associato agli organi mesodermici.<br /><br /><b>Ramo auricolare del nervo vago</b><br />(ABVN - auricular branch of vagus nerve), o branca auricolare, è l'unico esempio di innervazione cutanea da parte del vago. Innerva principalmente la conca, sia nell'area inferiore che superiore, e in parte il trago e l'antitrago e rappresenta i neuroni associati al tessuto endodermico.<br /><br /><b>Nervo occipitale minore</b><br />Deriva dal plesso cervicale superficiale (PCS, C2-C3). Innerva principalmente il corpo dell'antelice e la sua radice superiore, la fossa scafoidea e la zona dell'elice che si estende dall'apice del padiglione sino alla coda dell'elice, nonché la fossa triangolare.<br /><br /><b>Il grande nervo auricolare</b><br>Deriva anch'esso dal plesso cervicale superficiale (PCS, C2-C3) e innerva specialmente il lobulo e parte del corpo dell'antelice.<br />Le regioni auricolari innervare dal plesso solare corrispondono al tessuto ectodermico.<br /><br />L'innervazione del padiglione auricolare non è netta come potrebbe sembrare dalla descrizione, ma è fatta di un fitto intreccio di fibre nervose."
				},
				{
