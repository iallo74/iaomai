DB.set = {
	punti: {
		...
		"117": {
			...
			AzioniPunto: "<p><b>Other names</b><br>- Thymus</p><p><b>Action</b><br>Tonifies the immune defenses, has anti-inflammatory and anti-rheumatic actions.</p><p><b>Location</b><br>CW6-SC8, just above the concha ridge between the concha wall and the superior concha.</p>",
			ChiaviPunto: ""
		},
		"118": {
		...
		"127": {
			NomePunto: "Cardia",
			AzioniPunto: "<p><b>Other names</b><br>- Cardiac orifice<br>- Esophageal sphincter</p><p><b>Action</b><br>This point is indicated for the treatment of all disorders with an esophageal component, particularly gastroesophageal reflux, nausea, vomiting, esophagitis, hiatal hernia, and dyspepsia.</p><p><b>Location</b><br>IC7, in the inferior concha, near the concha ridge, just below and posterior to point [.000.].</p>",
			ChiaviPunto: ""
		},
		"128": {
			NomePunto: "Esophagus",
		...
		"247": {
			...
			AzioniPunto: "<p><b>Other names</b><br>- Ankle Muscles and Tendons</p><p><b>Action</b><br>This Point is adopted by both the Chinese School and the French School, albeit in different locations, for its properties in treating muscle-tendon disorders of the ankle and foot.</p><p><b>Location</b><br>PT3, at the base of the triangular prominence.</p>",
			ChiaviPunto: ""
		},
		"248": {
			NomePunto: "Foot Arch Muscles and Tendons CHN",
			AzioniPunto: "<p><b>Other names</b><br>- Ankle Muscles and Tendons</p><p><b>Action</b><br>This Point is adopted by both the Chinese School and the French School, albeit in different locations, for its properties in treating muscle-tendon disorders of the ankle and foot.</p><p><b>Location</b><br>PP12, on the posterior part of the helix, towards the apex of the pinna.</p>",
			ChiaviPunto: ""
		},
		"249": {
			NomePunto: "Lung EUR",
		...
		"264": {
			...
			AzioniPunto: "<p><b>Other names</b><br>- Pelvic girdle muscles</p><p><b>Action</b><br>This Point is adopted by both the Chinese School and the French School, albeit in different locations, for its properties in treating tendon muscle disorders and pelvic girdle.</p><p><b>Location</b><br>PT1, near the apex of the triangular eminence.</p>",
			ChiaviPunto: ""
		},
		"265": {
			NomePunto: "Hip muscles and tendons CHN",
			AzioniPunto: "<p><b>Other names</b><br>- Pelvic girdle muscles</p><p><b>Action</b><br>This Point is adopted by both the Chinese School and the French School, albeit in different locations, for its properties in treating tendon muscle disorders and pelvic girdle.</p><p><b>Location</b><br>PG8, on the posterior part of the helix, in its upper third.</p>",
			ChiaviPunto: ""
		},
		"266": {
		...
		"277": {
			...
			AzioniPunto: "<p><b>Action</b><br>The points Cervical Vertebrae is recognized by both the Chinese School and the French School, albeit in different locations, for its effectiveness in all pathologies related to the cervical vertebrae.</p><p><b>Location</b><br>AH8, in the lower third of the body of the antihelix, toward the scaphoid fossa.</p>",
			ChiaviPunto: ""
		},
		"278": {
			NomePunto: "Dorsal vertebrae CHN",
			AzioniPunto: "<p><b>Action</b><br>The points Dorsal Vertebrae is recognized by both the Chinese School and the French School, albeit in different locations, for its effectiveness in all pathologies related to the dorsal vertebrae.</p><p><b>Location</b><br>AH9-AH10, in the middle and upper thirds of the body of the antihelix, toward the scaphoid fossa.</p>",
			ChiaviPunto: ""
		},
		"279": {
			NomePunto: "Lumbar vertebrae CHN",
			AzioniPunto: "<p><b>Action</b><br>The Lumbar Vertebrae points is recognized by both the Chinese School and the French School, albeit in different locations, for its effectiveness in all pathologies related to lumbar vertebrae.</p><p><b>Location</b><br>AH1, in the upper part of the body of the antihelix, before it splits into the upper and lower roots of the antihelix.</p>",
			ChiaviPunto: ""
		},
		"280": {
			NomePunto: "Mandible",
		...
		"282": {
			...
			AzioniPunto: "<p><b>Action</b><br>This international point is used for its muscle-relaxing function on the lumbar and sacral muscles.</p><p><b>Location</b><br>PG5-PG6, in the posterior groove, in the lower-middle branch.</p>",
			ChiaviPunto: ""
		},
		"283": {
		...
		"284": {
			...
			AzioniPunto: "<p><b>Action</b><br>As indicated by the name, this point is very effective in reducing all disorders related to the coccygeal musculature.</p><p><b>Location</b><br>PG7, in the posterior groove, in the upper third of the lower-middle branch.</p>",
			ChiaviPunto: ""
		},
		"285": {
		...
		"029": {
			NomePunto: "Heel CHN",
			AzioniPunto: "<p><b>Other names</b><br>- Heel point</p><p><b>Action</b><br>This point is adopted by both the Chinese School and the French School, albeit in different locations, for its action in the contrast of ailments and pain in the heel.</p><p><b>Location</b><br>AH17, in the upper third of the upper root of the antihelix, in an area hidden by the helix rim and near the triangular fossa.</p>",
			ChiaviPunto: ""
		},
		"030": {
		...
		"043": {
			NomePunto: "Chest",
			AzioniPunto: "<p><b>Other names</b><br>- Chest<br>- Sternum<br>- Rib cage<br>- Pectoral muscles</p><p><b>Action</b><br>The Chest Point has an action of rebalancing rib and thoracic pain, and in the treatment of asthma, cough, and circulatory disorders.</p><p><b>Location</b><br>AH10, on the helix body at the height of the concha ridge, towards the scaphoid fossa.</p>",
			ChiaviPunto: ""
		},
		"044": {
		...
		"069": {
			...
			AzioniPunto: "<p><b>Action</b><br>Cervical Vertebral Points are recognized by both the Chinese School and the French School, albeit in different locations, for their effectiveness in all pathologies related to cervical vertebrae.</p><p><b>Location</b><br>AH1-AH2, in the crest of the antihelix, extending for about half the lower body of the antihelix.</p>",
			ChiaviPunto: ""
		},
		"070": {
			NomePunto: "Thoracic Vertebrae EUR",
			AzioniPunto: "<p><b>Action</b><br>Dorsal Vertebral Points are recognized by both the Chinese School and the French School, albeit in different locations, for their effectiveness in all pathologies related to the dorsal vertebrae.</p><p><b>Location</b><br>AH3-AH4-AH5, on the crest of the body of the antihelix in its upper half.</p>",
			ChiaviPunto: ""
		},
		"071": {
			NomePunto: "Lumbar Vertebrae EUR",
			AzioniPunto: "<p><b>Action</b><br>Lumbar Vertebrae Points are recognized by both the Chinese School and the French School, albeit in different locations, for their effectiveness in all pathologies related to lumbar vertebrae.</p><p><b>Location</b><br>AH5-AH6, on the crest of the lower root of the antihelix in the posterior two-thirds.</p>",
			ChiaviPunto: ""
		},
		"072": {
		...
		"085": {
			...
			AzioniPunto: "<p><b>Action</b><br>The Utero Point is recognized by both the Chinese School and the French School, albeit in different locations, for its effectiveness in all diseases related to the urinary tract, in particular the gynecological and reproductive system.</p><p><b>Location</b><br>IH3, on the hidden surface of the helix just below the point where the helix meets the lower root of the antihelix.</p>",
			ChiaviPunto: ""
		},
		"087": {
	...
	schede: {
		...
		37: {
			...
			s: [{
					...
					a: "Please note: apply this scheme as a complete protocol on one ear instead of the previous proposals. Repeat it cyclically every 2 or 3 sessions."
				}
			]
		},
		38: {
			...
			s: [{
					...
					a: "Please note: apply this scheme as a complete protocol on both ears and repeat it cyclically."
				}
			]
		},
		39: {
		...
		40: {
			g: {
				...
				d: "Please note: fatigue is the symptom for which patients undergo acupuncture, which is very effective in reducing its intensity."
			},
			s: [{
					t: "Muscle contraction",
					d: "On the dominant side",
		...
		79: {
			g: {
				...
				d: "Please note: the Sound Line (or Temporal Cortex) must be performed on the homolateral pinna to the problem. In the case of a bilateral problem, it can be performed on both pinnas or on the one most affected."
			},
			s: [{
					t: "Muscle contraction",
					d: "On the dominant side",
	...
	teoria: [
		...
		},
		{
			...
			contenuti: [{
					...
					TestoTeoria: "A schema proposed by D. Alimi and reinterpreted by A. Lovato, useful for rebalancing all cerebrovascular pathologies.<br>Only extemporaneus needles are used, without a specific order, to pierce the 4 points, and finally, a double-piercing needle is applied to their center.",
					gruppo: "RUO_VASC"
				}
			]
		}, { // test antitabacco
	...
	tests: {
		motivazione: {
			q: [{
					d: "I have decided to undergo spontaneously",
					r: [{
							t: "Yes",
							v: 2
						}, {
