var DB_patologie = {
	...
	"021": {
		...
		consigli: "Eliminate cigarette smoke, stay in environments with smog, dust, or toxic pollutants.<br>The management of bronchitis should include rest and fluid intake."
	},
	"022": {
		nomi: [
			"Urinary calculi",
	...
	"030": {
		...
		consigli: "Advise the individual to visit a specialist.<br>Take precautions to avoid contagion within the family or workplace.<br>Avoid exposure to direct light."
	},
	"031": {
		nomi: [
	...
	"064": {
		...
		consigli: "Sometimes, unintentionally, parents or family members tend to blame and distress affected children who already feel humiliated on their own. The best approach is to reassure and address the problem naturally, as an irrelevant and unimportant fact, without dwelling on changing sheets, washing and ironing, or even the bad smell, as these things not only do not help but worsen the situation."
	},
	"065": {
		nomi: [
			"Infertility",
